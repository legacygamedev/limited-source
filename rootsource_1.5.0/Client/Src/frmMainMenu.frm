...
Begin VB.Form frmMainMenu 
   ...
   Begin VB.PictureBox mnuNewCharacter 
      ...
      Begin VB.ComboBox cmbClass 
         ...
         ForeColor       =   &H00000000&
         Height          =   330
         ItemData        =   "frmMainMenu.frx":DA936
         Left            =   600
         List            =   "frmMainMenu.frx":DA938
   ...
   Begin VB.PictureBox mnuCredits 
      ...
      Height          =   5550
      Left            =   0
      Picture         =   "frmMainMenu.frx":1210D6
      ScaleHeight     =   5550
      ScaleWidth      =   3900
      TabIndex        =   26
      TabStop         =   0   'False
      ...
      Begin RichTextLib.RichTextBox txtSpecial 
         ...
         ScrollBars      =   2
         Appearance      =   0
         TextRTF         =   $"frmMainMenu.frx":167872
   ...
   Begin VB.PictureBox mnuNewAccount 
      ...
      Height          =   5550
      Left            =   0
      Picture         =   "frmMainMenu.frx":1678EE
      ScaleHeight     =   5550
      ScaleWidth      =   3900
      TabIndex        =   0
      TabStop         =   0   'False
   ...
   Begin VB.PictureBox mnuChars 
      ...
      Height          =   5550
      Left            =   0
      Picture         =   "frmMainMenu.frx":1AE08A
      ScaleHeight     =   5550
      ScaleWidth      =   3900
      TabIndex        =   7
      TabStop         =   0   'False
      ...
      Begin VB.ListBox lstChars 
         ...
         ForeColor       =   &H00000000&
         Height          =   870
         ItemData        =   "frmMainMenu.frx":1F4826
         Left            =   510
         List            =   "frmMainMenu.frx":1F4828
         TabIndex        =   8
         Top             =   2520
         Width           =   2895
      End
