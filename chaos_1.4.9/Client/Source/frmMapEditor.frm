...
Private Sub chkAT_Click()
    If chkAT.Value > 0 Then
        EditorTileY = (EditorTileY \ 6) * 6
        EditorTileX = 0
        shpSelected.Top = Int(EditorTileY * PIC_Y)
        shpSelected.Left = Int(EditorTileX * PIC_Y)
        frmMapEditor.shpSelected.Width = 8 * PIC_X
        frmMapEditor.shpSelected.Height = 6 * PIC_Y
    End If
End Sub
...
Private Sub picBackSelect_MouseDown(Button As Integer, Shift As Integer, x As Single, y As Single)
    If chkAT.Value > 0 Then
        ...
        frmMapEditor.shpSelected.Width = 8 * 32
        frmMapEditor.shpSelected.Height = 6 * 32
        Exit Sub
    End If
   If Button = 1 Then
...
Private Sub picBackSelect_MouseMove(Button As Integer, Shift As Integer, x As Single, y As Single)
    If chkAT.Value > 0 Then Exit Sub
    If Button = 1 Then
        If KeyShift = False Then
            Call EditorChooseTile(Button, Shift, x, y)
            shpSelected.Width = 32
