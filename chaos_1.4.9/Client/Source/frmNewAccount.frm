...
Begin VB.Form frmNewAccount 
   ...
   Begin VB.Label Label3 
      BackStyle       =   0  'Transparent
      Caption         =   "Retype Account Password:"
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   6.75
         Charset         =   0
...
Dim I As Long
    ...
    If Trim(txtName.Text) <> "" And Trim(txtPassword.Text) <> "" And Trim(txtPassword2.Text) <> "" Then
        ...
        If Len(Trim(txtEmail.Text)) < 6 Or Len(Trim(txtEmail2.Text)) < 6 Then
            MsgBox "Your Email Address must be at least Six characters in length"
            Exit Sub
        End If
        
        If Len(Trim(txtVault.Text)) < 7 Then
            MsgBox "Your Vault Password must be at least Seven characters in length"
            Exit Sub
        End If
