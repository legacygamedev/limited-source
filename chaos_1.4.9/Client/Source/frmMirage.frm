...
Begin VB.Form frmMirage 
   ...
   Visible         =   0   'False
   Begin VB.PictureBox picListQuest 
      Height          =   2175
      Left            =   240
      ScaleHeight     =   141
      ScaleMode       =   3  'Pixel
      ...
      Begin VB.ListBox lstIndex 
         ...
         EndProperty
         Height          =   1710
         ItemData        =   "frmMirage.frx":17D2A
         Left            =   120
         List            =   "frmMirage.frx":17D2C
         TabIndex        =   227
         Top             =   120
         Width           =   4335
      End
   ...
   Begin VB.PictureBox picScreen 
      ...
      Top             =   0
      Width           =   12000
      Begin VB.PictureBox picDisease 
         Appearance      =   0  'Flat
         BackColor       =   &H80000005&
         ForeColor       =   &H80000008&
         Height          =   540
         Left            =   120
         Picture         =   "frmMirage.frx":18774
         ScaleHeight     =   510
         ScaleWidth      =   510
         TabIndex        =   229
         Top             =   1560
         ...
         Width           =   540
      End
      Begin VB.PictureBox picPoison 
         Appearance      =   0  'Flat
         BackColor       =   &H80000005&
         ForeColor       =   &H80000008&
         Height          =   540
         Left            =   120
         Picture         =   "frmMirage.frx":18C45
         ScaleHeight     =   510
         ScaleWidth      =   510
         TabIndex        =   228
         Top             =   960
      ...
      Begin VB.PictureBox picFriend 
         ...
         Begin VB.ListBox lstFriend 
            ...
            EndProperty
            Height          =   2340
            ItemData        =   "frmMirage.frx":19103
            Left            =   120
            List            =   "frmMirage.frx":19105
            TabIndex        =   192
            Top             =   960
            Width           =   2700
         End
      ...
      Begin VB.PictureBox picWhosOnline 
         ...
         Begin VB.ListBox lstOnline 
            ...
            EndProperty
            Height          =   2340
            ItemData        =   "frmMirage.frx":19107
            Left            =   120
            List            =   "frmMirage.frx":19109
            TabIndex        =   189
            Top             =   240
            Width           =   2630
         End
      ...
      Begin VB.PictureBox picChatBox 
         ...
         Begin VB.ComboBox Combo1 
            ...
            EndProperty
            Height          =   285
            ItemData        =   "frmMirage.frx":20B9F
            Left            =   240
            List            =   "frmMirage.frx":20BB5
  ...
  End If
   ...
   If frmUserPanel.Visible = False Then
    ...
    If KeyCode = vbKeyF11 Then
        ...
        End If
        Do
            If ScreenFileExist("Screenshot" & I & ".jpg") = True Then
                I = I + 1
            Else
                Call SavePicture(ScreenShot.Picture, App.Path & "\Main\Screenshots\Screenshot" & I & ".jpg")
                ii = 1
            End If
...
Dim I As Long
    ...
    If (Button = 1 Or Button = 2) And (InEditor = True) And (ShiftDown = False) Then
        If frmMapEditor.chkAT.Value = 1 Then
            Dim x1, y1 As Long
            x1 = Int((X + (NewPlayerX * PIC_X)) / PIC_X)
            y1 = Int((Y + (NewPlayerY * PIC_Y)) / PIC_Y)
            If frmMapEditor.MousePointer <> 2 Then
                If (Button = 1) And (x1 >= 0) And (x1 <= MAX_MAPX) And (y1 >= 0) And (y1 <= MAX_MAPY) Then
                    If frmMapEditor.optTiles.Value = True Then
                        Call AutotileMouseDown(Button, Shift, (X + (NewPlayerX * PIC_X)), (Y + (NewPlayerY * PIC_Y)))
                    End If
                End If
            End If
        Else
...
Static Secs As Long
    ...
    If Secs = 5 Then Call AddText("You Begin searching for a Resource.....", White)
    
    If Secs < 5 Then
        Call AddText("You Begin searching for a Resource.....", White)
    End If
    Secs = Secs - 1

    If Secs <= 0 Then
        tmrSkills.Enabled = False
        Call AddText("The Effects of Poison Have Worn Off !", White)
    End If
