...
Begin VB.Form frmMirage 
   ...
   Begin VB.PictureBox picPlayerSpells 
      ...
      Begin VB.ListBox lstSpells 
         ...
         ForeColor       =   &H00000000&
         Height          =   2190
         ItemData        =   "frmMirage.frx":52174
         Left            =   45
         List            =   "frmMirage.frx":52176
         TabIndex        =   5
         Top             =   60
         Width           =   2535
      End
   ...
   Begin VB.PictureBox picWhosOnline 
      ...
      Begin VB.ListBox lstOnline 
         ...
         EndProperty
         Height          =   2340
         ItemData        =   "frmMirage.frx":52178
         Left            =   75
         List            =   "frmMirage.frx":5217A
         TabIndex        =   26
         Top             =   75
         Width           =   2460
      End
   ...
   Begin RichTextLib.RichTextBox txtChat 
      ...
      EndProperty
   End
   Begin VB.PictureBox musicplayer 
      Height          =   1815
      Left            =   13320
      ScaleHeight     =   1755
      ScaleWidth      =   3315
...
Private Sub CheatCheck_Timer()
    ...
    ' AFK check
    If AFK > 39 Then
        Call SendData("afk" & SEP_CHAR & MyIndex & SEP_CHAR & END_CHAR)
        Call MsgBox("You have been kicked for AFKing!", vbOKOnly, GAME_NAME)
        Unload Me
    End If
End Sub
...
Private Sub WindowsMediaPlayer2_OpenStateChange(ByVal NewState As Long)
