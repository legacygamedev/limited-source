...
Begin VB.Form frmItemEditor 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "frmItemEditor.frx":10AD
      ...
      Begin VB.Frame fraBow 
         ...
         Begin VB.ComboBox cmbBow 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmItemEditor.frx":10C9
            Left            =   120
            List            =   "frmItemEditor.frx":10CB
            Style           =   2  'Dropdown List
            TabIndex        =   73
            Top             =   600
            Width           =   2295
...
Private Sub cmbType_Click()
    ...
    If (cmbType.ListIndex = ITEM_TYPE_SCRIPT) Then
        fraSpell.Visible = False
        fraAttributes.Visible = False
        fraEquipment.Visible = False
        fraBow.Visible = False
    ...
    If (cmbType.ListIndex = ITEM_TYPE_POTIONPOISON) Then
        fraSpell.Visible = False
        fraAttributes.Visible = False
        fraEquipment.Visible = False
        fraBow.Visible = False
...
frmItemEditor.lblScript.Caption = scrlScript.Value
End Sub
