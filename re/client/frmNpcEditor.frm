...
Begin VB.Form frmNpcEditor 
   ...
   Begin VB.Frame Frame2 
      ...
      Top             =   3600
      Width           =   4695
      Begin VB.HScrollBar scrlpoisonS 
         Height          =   255
         Left            =   1680
         Max             =   500
         Min             =   1
      ...
      Begin VB.TextBox txtpoisonc 
         ...
         Width           =   615
      End
      Begin VB.Label lblpoisons 
         Alignment       =   2  'Center
         Caption         =   "Will take away 1 HP (2 per step)"
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   6.75
            Charset         =   0
      ...
      Begin VB.Label Label20 
         Caption         =   "Poison Player Chance                 Out of 100"
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   6.75
            Charset         =   0
...
Private Sub scrlpoisonS_Change()
lblpoison.Caption = "Poison Strength : " & scrlpoisonS.Value
lblpoisons.Caption = "Will take away " & scrlpoisonS.Value & " HP (2 per step)"
End Sub
...
Private Sub scrlSTR_Change()
    ...
    If scrlMAGI.Value > 0 Then
        temp = (scrlSTR.Value + scrlDEF.Value + scrlSPEED.Value + scrlMAGI.Value) / 4 + (StartHP.Value / 20)
        Label19.Caption = "Npc Level: " & temp
    Else
        temp = (scrlSTR.Value + scrlDEF.Value + scrlSPEED.Value) / 3 + (StartHP.Value / 20)
        Label19.Caption = "Npc Level: " & temp
    End If
End Sub
