    ...
    Select Case Dir
        Case DIR_UP
            ...
            If BY > 0 Then
                ...
                If Map(MapNum).Tile(BX, BY - 1).WalkUp = False Then
                    CanAttributeNPCMove = False
                    Exit Function
                End If
        ...
        Case DIR_DOWN
            ...
            If BY < MAX_MAPY Then
                ...
                ' Check direction blocks
                If Map(MapNum).Tile(BX, BY + 1).WalkDown = False Then
                    CanAttributeNPCMove = False
                    Exit Function
                End If
        ...
        Case DIR_LEFT
            ...
            If BX > 0 Then
                ...
                ' Check direction blocks
                If Map(MapNum).Tile(BX - 1, BY).WalkRight = False Then
                    CanAttributeNPCMove = False
                    Exit Function
                End If
        ...
        Case DIR_RIGHT
            ...
            If BX < MAX_MAPX Then
                ...
                ' Check direction blocks
                If Map(MapNum).Tile(BX + 1, BY).WalkLeft = False Then
                    CanAttributeNPCMove = False
                    Exit Function
                End If
