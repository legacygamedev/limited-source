...
Sub PutVar(File As String, Header As String, Var As String, Value As String)
    If Trim(Value) = "0" Or Trim(Value) = "" Then
        If ExistVar(File, Header, Var) = True Then
...
Sub CheckExps()
    If Not FileExist("experience.ini") Then
        ...
        For I = 1 To MAX_LEVEL
            ...
            DoEvents
            Call PutVar(App.Path & "\experience.ini", "EXPERIENCE", "Exp" & I, I * 250 + 750)
        Next I
    End If
End Sub
...
Dim n As Long
    ...
    For I = 1 To MAX_CHARS
        ...
        Call PutVar(FileName, "CHAR" & I, "Poison", STR(Player(index).Char(I).Poison))
