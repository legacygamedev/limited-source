...
Private sLastWord As String
Private sIntellText As String
Private LBoxPos As Long
...
Form_Load_Error:
    MsgBox "Error " & Err.number & " (" & Err.Description & ") in procedure Form_Load of Form frmEditor"
    Err.Clear
