...
Sub AdminMsg(ByVal Text As String)
  ...
  Dim packet As String
    ...
    packet = PacketID.AdminMsg & SEP_CHAR & Text & SEP_CHAR & END_CHAR
...
Sub BroadcastMsg(ByVal Text As String)
  ...
  Dim packet As String
    ...
    packet = PacketID.BroadcastMsg & SEP_CHAR & Text & SEP_CHAR & END_CHAR
    Call SendData(packet)
...
Sub EditMain()
  ...
  Dim packet As String
    ...
    packet = PacketID.EditMain & SEP_CHAR & END_CHAR
    Call SendData(packet)
...
Sub EmoteMsg(ByVal Text As String)
  ...
  Dim packet As String
    ...
    packet = PacketID.EmoteMsg & SEP_CHAR & Text & SEP_CHAR & END_CHAR
    Call SendData(packet)
...
Sub GlobalMsg(ByVal Text As String)
  ...
  Dim packet As String
    ...
    packet = PacketID.GlobalMsg & SEP_CHAR & Text & SEP_CHAR & END_CHAR
    Call SendData(packet)
...
Sub HandleData(ByVal Data As String)
  ...
  Dim TempStr As String
    ...
    If casestring = PacketID.MaxInfo Then
    ...
    If casestring = PacketID.NPCHP Then
        n = val#(parse$(1))
    ...
    If casestring = PacketID.AttributeNPCHP Then
        n = val#(parse$(1))
    ...
    If casestring = PacketID.Mail Then
    ...
    If casestring = PacketID.AlertMsg Then
    ...
    If casestring = PacketID.PlainMsg Then
        frmSendGetData.Visible = False
        n = val#(parse$(2))
    ...
    If casestring = PacketID.AllChars Then
    ...
    If casestring = PacketID.LoginOK Then
    ...
    If casestring = PacketID.News Then
    ...
    If casestring = PacketID.NewCharClasses Then
        n = 1
    ...
    If casestring = PacketID.ClassesData Then
        n = 1
    ...
    If casestring = PacketID.GameClock Then
        Seconds = val(parse$(1))
        Minutes = val(parse$(2))
        Hours = val(parse$(3))
    ...
    If casestring = PacketID.InGame Then
        frmSendGetData.Visible = True
    ...
    If casestring = PacketID.PlayerInv Then
        n = 2
        z = val#(parse$(1))
    ...
    If casestring = PacketID.PlayerInvUpdate Then
        n = val#(parse$(1))
        z = val#(parse$(2))
    ...
    If casestring = PacketID.PlayerBank Then
        n = 1
    ...
    If casestring = PacketID.PlayerBankUpdate Then
        n = val#(parse$(1))
    ...
    If casestring = PacketID.OpenBank Then
    ...
    If casestring = PacketID.BankMsg Then
    ...
    If casestring = PacketID.PlayerWornEQ Then
    ...
    If casestring = PacketID.PlayerPoints Then
        Player(MyIndex).POINTS = val#(parse$(1))
        frmMirage.lblPoints.Caption = val#(parse$(1))
        Exit Sub
    End If

    If casestring = PacketID.CusSprite Then
    ...
    If casestring = PacketID.PlayerHP Then
    ...
    If casestring = PacketID.PlayerMP Then
    ...
    If casestring = PacketID.MapMsg2 Then
    ...
    If casestring = PacketID.ScriptBubble Then
    ...
    If casestring = PacketID.PlayerSP Then
    ...
    If casestring = PacketID.PlayerStatsPacket Then
        Dim SubDef As Long
          Dim SubMagi As Long
    ...
    If casestring = PacketID.PlayerData Then
        Dim a As Long
        i = val#(parse$(1))
    ...
    If casestring = PacketID.PlayerLevel Then
        n = val#(parse$(1))
    ...
    If casestring = PacketID.UpdateSprite Then
        i = val#(parse$(1))
    ...
    If casestring = PacketID.PlayerMove Then
        i = val#(parse$(1))
        x = val#(parse$(2))
        y = val#(parse$(3))
        Dir = val#(parse$(4))
    ...
    If casestring = PacketID.NPCMove Then
        i = val#(parse$(1))
        x = val#(parse$(2))
        y = val#(parse$(3))
        Dir = val#(parse$(4))
    ...
    If casestring = PacketID.AttributeNPCMove Then
        i = val#(parse$(1))
        x = val#(parse$(2))
        y = val#(parse$(3))
        Dir = val#(parse$(4))
    ...
    If casestring = PacketID.PlayerDir Then
        i = val#(parse$(1))
        Dir = val#(parse$(2))
    ...
    If casestring = PacketID.NPCDir Then
        i = val#(parse$(1))
        Dir = val#(parse$(2))
        MapNpc(i).Dir = Dir
    ...
    If casestring = PacketID.AttributeNPCDir Then
        i = val#(parse$(1))
        Dir = val#(parse$(2))
    ...
    If casestring = PacketID.PlayerXY Then
        x = val#(parse$(1))
        y = val#(parse$(2))
    ...
    If casestring = PacketID.RemoveMembers Then
    ...
    If casestring = PacketID.UpdateMembers Then
    ...
    If casestring = PacketID.Attack Then
        i = val#(parse$(1))
    ...
    If casestring = PacketID.NPCAttack Then
        i = val#(parse$(1))
    ...
    If casestring = PacketID.AttributeNPCAttack Then
        i = val#(parse$(1))
    ...
    If casestring = PacketID.CheckForMap Then
        ...
        If FileExist("maps\map" & x & ".dat") Then
            ...
            If GetMapRevision(x) = y Then
                ...
                Call SendData(PacketID.NeedMap & SEP_CHAR & "no" & SEP_CHAR & END_CHAR)
                Exit Sub
            End If
        ...
        Call SendData(PacketID.NeedMap & SEP_CHAR & "yes" & SEP_CHAR & END_CHAR)
        Exit Sub
    End If
    ...
    If casestring = PacketID.MapData Then
        n = 1
    ...
    If casestring = PacketID.TileCheck Then
        n = 5
        x = val#(parse$(2))
        y = val#(parse$(3))
    ...
    If casestring = PacketID.TileCheckAttribute Then
        n = 5
        x = val#(parse$(2))
        y = val#(parse$(3))
    ...
    If casestring = PacketID.MapItemData Then
        n = 1
    ...
    If casestring = PacketID.MapNPCData Then
        n = 1
    ...
    '//!! Unused packet
    'If casestring = PacketID.MapAttributeNPCData Then
    '    n = 3
    '
    '    x = val#(parse$(1))
    '    y = val#(parse$(2))
    ...
    If casestring = PacketID.MapDone Then
        'Map = SaveMap
    ...
    If casestring = PacketID.SayMsg Or casestring = PacketID.BroadcastMsg Or casestring = PacketID.GlobalMsg Or casestring = PacketID.PlayerMsg Or casestring = PacketID.MapMsg Or casestring = PacketID.AdminMsg Then
    ...
    If casestring = PacketID.SpawnItem Then
        n = val#(parse$(1))
    ...
    If casestring = PacketID.ItemEditor Then
        InItemsEditor = True
    ...
    If casestring = PacketID.UpdateItem Then
        n = val#(parse$(1))
    ...
    If casestring = PacketID.EditItem Then
        n = val#(parse$(1))
    ...
    If casestring = PacketID.Mouse Then
    ...
    If casestring = PacketID.MapWeather Then
    ...
    If casestring = PacketID.SpawnNPC Then
        n = val#(parse$(1))
    ...
    If casestring = PacketID.SpawnAttributeNPC Then
        n = val#(parse$(1))
    ...
    If casestring = PacketID.NPCDead Then
        n = val#(parse$(1))
    ...
    If casestring = PacketID.AttributeNPCDead Then
        n = val#(parse$(1))
    ...
    If casestring = PacketID.NPCEditor Then
        InNpcEditor = True
    ...
    If casestring = PacketID.UpdateNPC Then
        n = val#(parse$(1))
    ...
    If casestring = PacketID.EditNPC Then
        n = val#(parse$(1))
    ...
    If casestring = PacketID.MapKey Then
        x = val#(parse$(1))
        y = val#(parse$(2))
        n = val#(parse$(3))
    ...
    If casestring = PacketID.EditMap Then
        Call EditorInit
        Exit Sub
    End If
    ...
    If casestring = PacketID.EditHouse Then
    ...
    If casestring = PacketID.Main Then
    ...
    If casestring = PacketID.ShopEditor Then
        InShopEditor = True
    ...
    If casestring = PacketID.UpdateShop Then
        n = val#(parse$(1))
    ...
    If casestring = PacketID.EditShop Then
    ...
    If casestring = PacketID.SpellEditor Then
        InSpellEditor = True
    ...
    If casestring = PacketID.UpdateSpell Then
        n = val#(parse$(1))
    ...
    If casestring = PacketID.EditSpell Then
        n = val#(parse$(1))
    ...
    If casestring = PacketID.GoShop Then
        shopNum = val#(parse$(1))
        'Show the shop
        Call GoShop(shopNum)
    End If
    ...
    If casestring = PacketID.Spells Then
    ...
    If casestring = PacketID.Weather Then
    ...
    If casestring = PacketID.NameColor Then
    ...
    If casestring = PacketID.Fog Then
    ...
    If casestring = PacketID.Lights Then
    ...
    If casestring = PacketID.OnlineList Then
    ...
    If casestring = PacketID.BlitPlayerDmg Then
        DmgDamage = val#(parse$(1))
        NPCWho = val#(parse$(2))
        NPCWhoX = MapNpc(NPCWho).x + MapNpc(NPCWho).XOffset  '//!! Stored the NPC position when damage is set
        NPCWhoY = MapNpc(NPCWho).y + MapNpc(NPCWho).YOffset
    ...
    If casestring = PacketID.BlitNPCDmg Then
    ...
    If casestring = PacketID.PPTrading Then
    ...
    If casestring = PacketID.QTrade Then
    ...
    If casestring = PacketID.OnCanon Then
        CanonUsed = 1
        Exit Sub
    End If

    If casestring = PacketID.CanonOff Then
        CanonUsed = 0
        Exit Sub
    End If
    ...
    If casestring = PacketID.DTime Then
    ...
    If casestring = PacketID.UpdateTradeItem Then
        n = val#(parse$(1))
    ...
    If casestring = PacketID.Trading Then
        n = val#(parse$(1))
    ...
    If casestring = PacketID.PPChatting Then
    ...
    If casestring = PacketID.QChat Then
        frmPlayerChat.txtChat.Text = vbNullString
        frmPlayerChat.txtSay.Text = vbNullString
    ...
    If casestring = PacketID.SendChat Then
        Dim s As String
    ...
    If casestring = PacketID.Sound Then
        s = LCase$(parse$(1))
    ...
    If casestring = PacketID.SpriteChange Then
        If val#(parse$(1)) = 1 Then
            i = MsgBox("Would you like to buy this sprite?", 4, "Buying Sprite")

            If i = 6 Then
                Call SendData(PacketID.BuySprite & SEP_CHAR & END_CHAR)
            End If
    ...
    If casestring = PacketID.HouseBuy Then
        If val#(parse$(1)) = 1 Then
            i = MsgBox("Would you like to buy this house?", 4, "Buying House")

            If i = 6 Then
                Call SendData(PacketID.BuyHouse & SEP_CHAR & END_CHAR)
            End If
    ...
    If casestring = PacketID.ChangeDir Then
    ...
    If casestring = PacketID.FlashEvent Then
    ...
    If casestring = PacketID.Prompt Then
        i = MsgBox(Trim$(parse$(1)), vbYesNo)
        Call SendData(PacketID.Prompt & SEP_CHAR & i & SEP_CHAR & val#(parse$(2)) & SEP_CHAR & END_CHAR)
        Exit Sub
    End If
    ...
    If casestring = PacketID.QueryBox Then
    ...
    If casestring = PacketID.EmoticonEditor Then
    ...
    If casestring = PacketID.ElementEditor Then
    ...
    If casestring = PacketID.QuestEditor Then
    ...
    If casestring = PacketID.EditQuest Then
        n = val#(parse$(1))
    ...
    If casestring = PacketID.UpdateQuest Then
        n = val#(parse$(1))
    ...
    If casestring = PacketID.SkillEditor Then
    ...
    If casestring = PacketID.EditSkill Then
        n = val#(parse$(1))
    ...
    If casestring = PacketID.UpdateSkill Then
        n = val#(parse$(1))
    ...
    If casestring = PacketID.SkillInfo Then
        n = val#(parse$(1))
    ...
    If casestring = PacketID.EditElement Then
        n = val#(parse$(1))
    ...
    If casestring = PacketID.UpdateElement Then
        n = val#(parse$(1))
    ...
    If casestring = PacketID.EditEmoticon Then
        n = val#(parse$(1))
    ...
    If casestring = PacketID.UpdateEmoticon Then
        n = val#(parse$(1))
    ...
    If casestring = PacketID.ArrowEditor Then
        InArrowEditor = True
    ...
    If casestring = PacketID.UpdateArrow Then
        n = val#(parse$(1))
    ...
    If casestring = PacketID.EditArrow Then
        n = val#(parse$(1))
    ...
    If casestring = PacketID.HookShot Then
        n = val#(parse$(1))
        i = val#(parse$(3))
    ...
    If casestring = PacketID.CheckArrows Then
        n = val#(parse$(1))
        z = val#(parse$(2))
        i = val#(parse$(3))
        p = val#(parse$(4))
    ...
    If casestring = PacketID.CheckSprite Then
        n = val#(parse$(1))
    ...
    If casestring = PacketID.MapReport Then
        n = 1
    ...
    If casestring = PacketID.ActionName Then
    ...
    If casestring = PacketID.Time Then
    ...
    If casestring = PacketID.Wierd Then
        Wierd = val#(parse$(1))
    ...
    If casestring = PacketID.SpellAnim Then
    ...
    If casestring = PacketID.ScriptSpellAnim Then
    ...
    If casestring = PacketID.CheckEmoticons Then
        n = val#(parse$(1))
    ...
    If casestring = PacketID.LevelUp Then
        Player(val(parse$(1))).LevelUpT = GetTickCount
        Player(val(parse$(1))).LevelUp = 1
        Exit Sub
    End If

    If casestring = PacketID.DamageDisplay Then
    ...
    '//!! Unused packet
    'If casestring = PacketID.ItemBreak Then
    ...
    If casestring = PacketID.ItemWorn Then
    ...
    If casestring = PacketID.ScriptTile Then
        frmScript.lblScript.Caption = parse$(1)
        Exit Sub
    End If
    
    '//!! Unused packet
    'If casestring = PacketID.ForceCloseHouse Then
    ...
    If casestring = PacketID.SetSpeed Then
    ...
    If casestring = PacketID.ShowCustomMenu Then
        'Error handling
    ...
    If casestring = PacketID.CloseCustomMenu Then
    ...
    If casestring = PacketID.LoadPicCustomMenu Then
    ...
    If casestring = PacketID.LoadLabelCustomMenu Then
    ...
    If casestring = PacketID.LoadTextBoxCustomMenu Then
    ...
    If casestring = PacketID.LoadInternetWindow Then
        customtext = parse$(1)
        'DEBUG STRING
    ...
    If casestring = PacketID.ReturningCustomBoxMsg Then
        customsize = parse$(1)

        packet = PacketID.ReturningCustomBoxMsg & SEP_CHAR & frmCustom1.txtCustom(customsize).Text & SEP_CHAR & END_CHAR
        Call SendData(packet)
...
Sub Mail()
  ...
  Dim packet As String
    ...
    packet = PacketID.Mail & SEP_CHAR & END_CHAR
    Call SendData(packet)
...
Sub MapMsg(ByVal Text As String)
  ...
  Dim packet As String
    ...
    packet = PacketID.MapMsg & SEP_CHAR & Text & SEP_CHAR & END_CHAR
    Call SendData(packet)
...
Sub PlayerMsg(ByVal Text As String, ByVal MsgTo As String)
  ...
  Dim packet As String
    ...
    packet = PacketID.PlayerMsg & SEP_CHAR & MsgTo & SEP_CHAR & Text & SEP_CHAR & END_CHAR
    Call SendData(packet)
...
Sub SaveMain(ByVal Text As String)
  ...
  Dim packet As String
    ...
    packet = PacketID.SaveMain & SEP_CHAR & Text & SEP_CHAR & END_CHAR
    Call SendData(packet)
...
Sub SayMsg(ByVal Text As String)
  ...
  Dim packet As String
    ...
    packet = PacketID.SayMsg & SEP_CHAR & Text & SEP_CHAR & END_CHAR
    Call SendData(packet)
...
Sub SendAcceptTrade()
  ...
  Dim packet As String
    ...
    packet = PacketID.ATrade & SEP_CHAR & END_CHAR
    Call SendData(packet)
...
Sub SendAddChar(ByVal Name As String, ByVal Sex As Long, ByVal ClassNum As Long, ByVal slot As Long, ByVal headc As Long, ByVal bodyc As Long, ByVal legc As Long)
  ...
  Dim packet As String
    ...
    packet = PacketID.AddAChara & SEP_CHAR & Trim$(Name) & SEP_CHAR & Sex & SEP_CHAR & ClassNum & SEP_CHAR & slot & SEP_CHAR & headc & SEP_CHAR & bodyc & SEP_CHAR & legc & SEP_CHAR & END_CHAR
    Call SendData(packet)
...
Sub SendBan(ByVal Name As String)
  ...
  Dim packet As String
    ...
    packet = PacketID.BanPlayer & SEP_CHAR & Name & SEP_CHAR & END_CHAR
    Call SendData(packet)
...
Sub SendBanDestroy()
  ...
  Dim packet As String
    ...
    packet = PacketID.BanDestroy & SEP_CHAR & END_CHAR
    Call SendData(packet)
...
Sub SendBanList()
  ...
  Dim packet As String
    ...
    packet = PacketID.Banlist & SEP_CHAR & END_CHAR
    Call SendData(packet)
...
Sub SendDeclineTrade()
  ...
  Dim packet As String
    ...
    packet = PacketID.DTrade & SEP_CHAR & END_CHAR
    Call SendData(packet)
...
Sub SendDelAccount(ByVal Name As String, ByVal Password As String)
  ...
  Dim packet As String
    ...
    packet = PacketID.DelimAccounted & SEP_CHAR & Trim$(Name) & SEP_CHAR & Trim$(Password) & SEP_CHAR & END_CHAR
    Call SendData(packet)
...
Sub SendDelChar(ByVal slot As Long)
  ...
  Dim packet As String
    ...
    packet = PacketID.DelimboCharu & SEP_CHAR & slot & SEP_CHAR & END_CHAR
    Call SendData(packet)
...
Sub SendDropItem(ByVal InvNum, ByVal Ammount As Long)
  ...
  Dim packet As String
    ...
    packet = PacketID.MapDropItem & SEP_CHAR & InvNum & SEP_CHAR & Ammount & SEP_CHAR & END_CHAR
    Call SendData(packet)
...
Sub SendEasterEgg()
  ...
  Dim packet As String
    ...
    '//!! Removed since theres no reference to packet on server
...
Sub SendGetClasses()
  ...
  Dim packet As String
    ...
    packet = PacketID.GatGlasses & SEP_CHAR & END_CHAR
    Call SendData(packet)
...
Sub SendHotScript1()
  ...
  Dim packet As String
    ...
    packet = PacketID.HotScript1 & SEP_CHAR & END_CHAR
    Call SendData(packet)
...
Sub SendHotScript2()
  ...
  Dim packet As String
    ...
    packet = PacketID.HotScript2 & SEP_CHAR & END_CHAR
    Call SendData(packet)
...
Sub SendHotScript3()
  ...
  Dim packet As String
    ...
    packet = PacketID.HotScript3 & SEP_CHAR & END_CHAR
    Call SendData(packet)
...
Sub SendHotScript4()
  ...
  Dim packet As String
    ...
    packet = PacketID.HotScript4 & SEP_CHAR & END_CHAR
    Call SendData(packet)
...
Sub SendJoinParty()
  ...
  Dim packet As String
    ...
    packet = PacketID.JoinParty & SEP_CHAR & END_CHAR
    Call SendData(packet)
...
Sub SendKick(ByVal Name As String)
  ...
  Dim packet As String
    ...
    packet = PacketID.KickPlayer & SEP_CHAR & Name & SEP_CHAR & END_CHAR
    Call SendData(packet)
...
Sub SendLeaveParty()
  ...
  Dim packet As String
    ...
    packet = PacketID.LeaveParty & SEP_CHAR & END_CHAR
    Call SendData(packet)
...
Sub SendLogin(ByVal Name As String, ByVal Password As String)
  ...
  Dim packet As String
    ...
    packet = PacketID.Logination & SEP_CHAR & Trim$(Name) & SEP_CHAR & Trim$(Password) & SEP_CHAR & App.Major & SEP_CHAR & App.Minor & SEP_CHAR & App.Revision & SEP_CHAR & SEC_CODE1 & SEP_CHAR & SEC_CODE2 & SEP_CHAR & SEC_CODE3 & SEP_CHAR & SEC_CODE4 & SEP_CHAR & END_CHAR
    Call SendData(packet)
...
Sub SendMapRespawn()
  ...
  Dim packet As String
    ...
    packet = PacketID.MapRespawn & SEP_CHAR & END_CHAR
    Call SendData(packet)
...
Sub SendMOTDChange(ByVal MOTD As String)
  ...
  Dim packet As String
    ...
    packet = PacketID.SetMOTD & SEP_CHAR & MOTD & SEP_CHAR & END_CHAR
    Call SendData(packet)
...
Sub SendNewAccount(ByVal Name As String, ByVal Password As String, ByVal Email As String)
  ...
  Dim packet As String
    ...
    packet = PacketID.NewFAccountIED & SEP_CHAR & Trim$(Name) & SEP_CHAR & Trim$(Password) & SEP_CHAR & Trim$(Email) & SEP_CHAR & END_CHAR
    Call SendData(packet)
...
Sub SendOnlineList()
  ...
  Dim packet As String
    ...
    packet = PacketID.OnlineList & SEP_CHAR & END_CHAR
    Call SendData(packet)
...
Sub SendPartyRequest(ByVal Name As String)
  ...
  Dim packet As String
    ...
    packet = PacketID.Party & SEP_CHAR & Name & SEP_CHAR & END_CHAR
    Call SendData(packet)
...
Sub SendPlayerDir()
  ...
  Dim packet As String
    ...
    packet = PacketID.PlayerDir & SEP_CHAR & GetPlayerDir(MyIndex) & SEP_CHAR & END_CHAR
    Call SendData(packet)
...
Sub SendPlayerMove()
  ...
  Dim packet As String
    ...
    packet = PacketID.PlayerMove & SEP_CHAR & GetPlayerDir(MyIndex) & SEP_CHAR & Player(MyIndex).Moving & SEP_CHAR & END_CHAR
    Call SendData(packet)
...
Sub SendPlayerMovemouse()
  ...
  Dim packet As String
    ...
    packet = PacketID.PlayerMoveMouse & SEP_CHAR & GetPlayerDir(MyIndex) & SEP_CHAR & END_CHAR
    Call SendData(packet)
...
Sub SendPlayerRequestNewMap(ByVal Cancel As Long)
  ...
  Dim packet As String
    ...
    packet = PacketID.RequestNewMap & SEP_CHAR & GetPlayerDir(MyIndex) & SEP_CHAR & Cancel & SEP_CHAR & END_CHAR
    Call SendData(packet)
...
Sub SendReloadScripts()
  ...
  Dim packet As String
    ...
    packet = PacketID.ReloadScripts & SEP_CHAR & END_CHAR
    Call SendData(packet)
...
Sub SendRequestEditArrow()
  ...
  Dim packet As String
    ...
    packet = PacketID.RequestEditArrow & SEP_CHAR & END_CHAR
    Call SendData(packet)
...
Sub SendRequestEditElement()
  ...
  Dim packet As String
    ...
    packet = PacketID.RequestEditElement & SEP_CHAR & END_CHAR
    Call SendData(packet)
...
Sub SendRequestEditEmoticon()
  ...
  Dim packet As String
    ...
    packet = PacketID.RequestEditEmoticon & SEP_CHAR & END_CHAR
    Call SendData(packet)
...
Sub SendRequestEditHouse()
  ...
  Dim packet As String
    ...
    packet = PacketID.RequestEditHouse & SEP_CHAR & END_CHAR
    Call SendData(packet)
...
Sub SendRequestEditItem()
  ...
  Dim packet As String
    ...
    packet = PacketID.RequestEditItem & SEP_CHAR & END_CHAR
    Call SendData(packet)
...
Sub SendRequestEditMap()
  ...
  Dim packet As String
    ...
    packet = PacketID.RequestEditMap & SEP_CHAR & END_CHAR
    Call SendData(packet)
...
Sub SendRequestEditNpc()
  ...
  Dim packet As String
    ...
    packet = PacketID.RequestEditNPC & SEP_CHAR & END_CHAR
    Call SendData(packet)
...
Sub SendRequestEditQuest()
  ...
  Dim packet As String
    ...
    packet = PacketID.RequestEditQuest & SEP_CHAR & END_CHAR
    Call SendData(packet)
...
Sub SendRequestEditShop()
  ...
  Dim packet As String
    ...
    packet = PacketID.RequestEditShop & SEP_CHAR & END_CHAR
    Call SendData(packet)
...
Sub SendRequestEditSkill()
  ...
  Dim packet As String
    ...
    packet = PacketID.RequestEditSkill & SEP_CHAR & END_CHAR
    Call SendData(packet)
...
Sub SendRequestEditSpell()
  ...
  Dim packet As String
    ...
    packet = PacketID.RequestEditSpell & SEP_CHAR & END_CHAR
    Call SendData(packet)
...
Sub SendRequestLocation()
  ...
  Dim packet As String
    ...
    packet = PacketID.RequestLocation & SEP_CHAR & END_CHAR
    Call SendData(packet)
...
Sub SendSaveArrow(ByVal ArrowNum As Long)
  ...
  Dim packet As String
    ...
    packet = PacketID.SaveArrow & SEP_CHAR & ArrowNum & SEP_CHAR & Trim$(Arrows(ArrowNum).Name) & SEP_CHAR & Arrows(ArrowNum).Pic & SEP_CHAR & Arrows(ArrowNum).Range & SEP_CHAR & Arrows(ArrowNum).Amount & SEP_CHAR & END_CHAR
    Call SendData(packet)
...
Sub SendSaveElement(ByVal ElementNum As Long)
  ...
  Dim packet As String
    ...
    packet = PacketID.SaveElement & SEP_CHAR & ElementNum & SEP_CHAR & Trim$(Element(ElementNum).Name) & SEP_CHAR & Element(ElementNum).Strong & SEP_CHAR & Element(ElementNum).Weak & SEP_CHAR & END_CHAR
    Call SendData(packet)
...
Sub SendSaveEmoticon(ByVal EmoNum As Long)
  ...
  Dim packet As String
    ...
    packet = PacketID.SaveEmoticon & SEP_CHAR & EmoNum & SEP_CHAR & Trim$(Emoticons(EmoNum).Command) & SEP_CHAR & Emoticons(EmoNum).Pic & SEP_CHAR & END_CHAR
    Call SendData(packet)
...
Sub SendSaveItem(ByVal ItemNum As Long)
  ...
  Dim packet As String
    ...
    packet = PacketID.SaveItem & SEP_CHAR & ItemNum & SEP_CHAR & Trim$(item(ItemNum).Name) & SEP_CHAR & item(ItemNum).Pic & SEP_CHAR & item(ItemNum).Type & SEP_CHAR & item(ItemNum).Data1 & SEP_CHAR & item(ItemNum).Data2 & SEP_CHAR & item(ItemNum).Data3 & SEP_CHAR & item(ItemNum).StrReq & SEP_CHAR & item(ItemNum).DefReq & SEP_CHAR & item(ItemNum).SpeedReq & SEP_CHAR & item(ItemNum).ClassReq & SEP_CHAR & item(ItemNum).AccessReq & SEP_CHAR
...
Sub SendSaveNpc(ByVal NpcNum As Long)
  ...
  Dim i As Long
    ...
    packet = PacketID.SaveNPC & SEP_CHAR & NpcNum & SEP_CHAR & Trim$(Npc(NpcNum).Name) & SEP_CHAR & Trim$(Npc(NpcNum).AttackSay) & SEP_CHAR & Npc(NpcNum).Sprite & SEP_CHAR & Npc(NpcNum).SpawnSecs & SEP_CHAR & Npc(NpcNum).Behavior & SEP_CHAR & Npc(NpcNum).Range & SEP_CHAR & Npc(NpcNum).STR & SEP_CHAR & Npc(NpcNum).DEF & SEP_CHAR & Npc(NpcNum).speed & SEP_CHAR & Npc(NpcNum).MAGI & SEP_CHAR & Npc(NpcNum).Big & SEP_CHAR & Npc(NpcNum).MaxHp & SEP_CHAR & Npc(NpcNum).Exp & SEP_CHAR & Npc(NpcNum).SpawnTime & SEP_CHAR & Npc(NpcNum).Element & SEP_CHAR & Npc(NpcNum).Spritesize & SEP_CHAR
...
Sub SendSaveQuest(ByVal QuestNum As Long)
  ...
  Dim j As Long
    ...
    packet = PacketID.SaveQuest & SEP_CHAR & QuestNum & SEP_CHAR & Trim$(Quest(QuestNum).Name) & SEP_CHAR & val(Quest(QuestNum).Pictop) & SEP_CHAR & val(Quest(QuestNum).Picleft)
...
Sub SendSaveShop(ByVal shopNum As Long)
  ...
  Dim i As Integer
    ...
    packet = PacketID.SaveShop & SEP_CHAR & shopNum & SEP_CHAR & Trim$(Shop(shopNum).Name) & SEP_CHAR & Shop(shopNum).FixesItems & SEP_CHAR & Shop(shopNum).BuysItems & SEP_CHAR & Shop(shopNum).ShowInfo & SEP_CHAR & Shop(shopNum).currencyItem & SEP_CHAR
...
Sub SendSaveSkill(ByVal SkillNum As Long)
  ...
  Dim j As Long
    ...
    packet = PacketID.SaveSkill & SEP_CHAR & SkillNum & SEP_CHAR & Trim$(skill(SkillNum).Name) & SEP_CHAR & Trim$(skill(SkillNum).Action) & SEP_CHAR & Trim$(skill(SkillNum).Fail) & SEP_CHAR & Trim$(skill(SkillNum).Succes) & SEP_CHAR & Trim$(skill(SkillNum).AttemptName) & SEP_CHAR & val(skill(SkillNum).Pictop) & SEP_CHAR & val(skill(SkillNum).Picleft)
...
Sub SendScriptTile(ByVal Text As String)
  ...
  Dim packet As String
    ...
    packet = PacketID.ScriptTile & SEP_CHAR & Text & SEP_CHAR & END_CHAR
    Call SendData(packet)
...
Sub SendSetAccess(ByVal Name As String, ByVal Access As Byte)
  ...
  Dim packet As String
    ...
    packet = PacketID.SetAccess & SEP_CHAR & Name & SEP_CHAR & Access & SEP_CHAR & END_CHAR
    Call SendData(packet)
...
Sub SendSetPlayerSprite(ByVal Name As String, ByVal SpriteNum As Byte)
  ...
  Dim packet As String
    ...
    packet = PacketID.SetPlayerSprite & SEP_CHAR & Name & SEP_CHAR & SpriteNum & SEP_CHAR & END_CHAR
    Call SendData(packet)
...
Sub SendSetSprite(ByVal SpriteNum As Long)
  ...
  Dim packet As String
    ...
    packet = PacketID.SetSprite & SEP_CHAR & SpriteNum & SEP_CHAR & END_CHAR
    Call SendData(packet)
...
Sub SendTradeRequest(ByVal Name As String)
  ...
  Dim packet As String
    ...
    packet = PacketID.PPTrade & SEP_CHAR & Name & SEP_CHAR & END_CHAR
    Call SendData(packet)
...
Sub SendUseChar(ByVal CharSlot As Long)
  ...
  Dim packet As String
    ...
    packet = PacketID.Usagakarim & SEP_CHAR & CharSlot & SEP_CHAR & END_CHAR
    Call SendData(packet)
...
Sub SendUseItem(ByVal InvNum As Long)
  ...
  Dim packet As String
    ...
    packet = PacketID.UseItem & SEP_CHAR & InvNum & SEP_CHAR & END_CHAR
    Call SendData(packet)
...
Sub SendWhosOnline()
  ...
  Dim packet As String
    ...
    packet = PacketID.WhosOnline & SEP_CHAR & END_CHAR
    Call SendData(packet)
...
Sub Warp()
  ...
  Dim packet As String
    ...
    packet = PacketID.Warp & SEP_CHAR & GetPlayerDir(MyIndex) & SEP_CHAR & END_CHAR
    Call SendData(packet)
...
Sub WarpTo(ByVal MapNum As Long)
  ...
  Dim packet As String
    ...
    packet = PacketID.WarpTo & SEP_CHAR & MapNum & SEP_CHAR & END_CHAR
    Call SendData(packet)
