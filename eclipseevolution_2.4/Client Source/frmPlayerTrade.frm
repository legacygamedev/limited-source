...
Private Sub Command1_Click()
  ...
  Dim i As Long
    ...
    packet = PacketID.SwapItems & SEP_CHAR
                 ...
                 Else
                    ...
                    If GetPlayerWeaponSlot(MyIndex) = i Or GetPlayerArmorSlot(MyIndex) = i Or GetPlayerHelmetSlot(MyIndex) = i Or GetPlayerShieldSlot(MyIndex) = i Or GetPlayerLegsSlot(MyIndex) = i Or GetPlayerRingSlot(MyIndex) = i Or GetPlayerNecklaceSlot(MyIndex) = i Then
                     ...
                     Else
                        ...
                        Call SendData(PacketID.UpdateTradeInv & SEP_CHAR & n & SEP_CHAR & Trading(n).InvNum & SEP_CHAR & Trading(n).InvName & SEP_CHAR & END_CHAR)
                        Exit Sub
                    End If
...
Private Sub Command4_Click()
  ...
  Dim n As Long
    ...
    Call SendData(PacketID.UpdateTradeInv & SEP_CHAR & i & SEP_CHAR & 0 & SEP_CHAR & vbNullString & SEP_CHAR & END_CHAR)
...
Private Sub Command5_Click()
    ...
    Call SendData(PacketID.QTrade & SEP_CHAR & END_CHAR)
