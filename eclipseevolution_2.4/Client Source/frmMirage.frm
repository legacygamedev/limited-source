...
Private Sub AddDef_Click()
    Call SendData(PacketID.UseStatPoint & SEP_CHAR & 1 & SEP_CHAR & END_CHAR)
End Sub

Private Sub AddMagi_Click()
    Call SendData(PacketID.UseStatPoint & SEP_CHAR & 2 & SEP_CHAR & END_CHAR)
End Sub

Private Sub AddSpeed_Click()
    Call SendData(PacketID.UseStatPoint & SEP_CHAR & 3 & SEP_CHAR & END_CHAR)
End Sub

Private Sub AddStr_Click()
    Call SendData(PacketID.UseStatPoint & SEP_CHAR & 0 & SEP_CHAR & END_CHAR)
End Sub
...
Private Sub chkmusic_Click()
    ...
    '//!! BGM stopping/resuming upon setting change
...
Dim packet As String
    packet = PacketID.GuildLeave & SEP_CHAR & END_CHAR
    Call SendData(packet)
End Sub

Private Sub cmdMember_Click()
Dim packet As String
    packet = PacketID.GuildMember & SEP_CHAR & txtName.Text & SEP_CHAR & END_CHAR
    Call SendData(packet)
End Sub
...
For i = 1 To MAX_PLAYERS
    If IsPlaying(i) = True Then
        If MouseDownX = GetPlayerX(i) And MouseDownY = GetPlayerY(i) Then
            Call SendData(PacketID.PlayerChat & SEP_CHAR & GetPlayerName(i) & SEP_CHAR & END_CHAR)
            Exit Sub
        End If
    End If
Next i
...
Private Sub Label8_Click()
    Call SendData(PacketID.Spells & SEP_CHAR & END_CHAR)
    picInv3.Visible = False
    frmMirage.picGuildAdmin.Visible = False
    'picEquip.Visible = False
    Picture1(0).Visible = False
...
Call SendData(PacketID.ForgetSpell & SEP_CHAR & lstSpells.ListIndex + 1 & SEP_CHAR & END_CHAR)
picPlayerSpells.Visible = False
End If
Else
...
Private Sub lstOnline_DblClick()
    Call SendData(PacketID.PlayerChat & SEP_CHAR & Trim$(lstOnline.Text) & SEP_CHAR & END_CHAR)
End Sub
...
Dim ii As Long
    ...
    Call SendData(PacketID.Key & SEP_CHAR & KeyCode & SEP_CHAR & END_CHAR)
...
For i = 1 To MAX_INV
    ...
    If GetPlayerInvItemNum(MyIndex, i) > 0 And GetPlayerInvItemNum(MyIndex, i) <= MAX_ITEMS Then
        ...
        End If
    Else
            If i = MAX_INV Then Call AddText("You dont have any healing potions!", Red)
    End If
    Next i
End If
        ...
        If SpellMemorized > 0 Then
            If GetTickCount > Player(MyIndex).AttackTimer + 1000 Then
                If Player(MyIndex).Moving = 0 Then
                    Call SendData(PacketID.Cast & SEP_CHAR & SpellMemorized & SEP_CHAR & END_CHAR)
...
Dim packet As String
    ...
    packet = PacketID.GuildChangeAccess & SEP_CHAR & txtName.Text & SEP_CHAR & txtAccess.Text & SEP_CHAR & END_CHAR
    Call SendData(packet)
End Sub
...
Dim packet As String
    ...
    packet = PacketID.GuildDisown & SEP_CHAR & txtName.Text & SEP_CHAR & END_CHAR
    Call SendData(packet)
End Sub
...
Dim packet As String
    ...
    packet = PacketID.GuildTrainee & SEP_CHAR & txtName.Text & SEP_CHAR & END_CHAR
    Call SendData(packet)
End Sub
