...
Public Function GetShopItemAmt(ByVal item As Integer)

    If item > 0 And item < 26 Then
...
Public Function GetShopItemNum(ByVal item As Integer)
...
Public Function GetShopItemPrice(ByVal item As Integer)
