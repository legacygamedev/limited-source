...
Dim s As String
    ...
    s = vbNewLine & Msg
    frmEndieko.txtChat.SelStart = Len(frmEndieko.txtChat.Text)
    frmEndieko.txtChat.SelColor = QBColor(Color)
    frmEndieko.txtChat.SelText = s
    frmEndieko.txtChat.SelStart = Len(frmEndieko.txtChat.Text) - 1
End Sub
