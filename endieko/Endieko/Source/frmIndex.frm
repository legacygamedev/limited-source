...
Private Sub cmdOK_Click()
    ...
    End If
    If InScriptEditor = True Then
        Call SendData("EDITSCRIPT" & SEP_CHAR & EditorIndex & SEP_CHAR & END_CHAR)
    End If
    If InEffectEditor = True Then
        Call SendData("EDITEffect" & SEP_CHAR & EditorIndex & SEP_CHAR & END_CHAR)
    End If
    Unload frmIndex
End Sub
