...
If optMale.Value = True Then
    Call BitBlt(Picpic.hDC, 0, 0, PIC_X, PIC_Y, Picsprites.hDC, animi * PIC_X, Int(Class(0).MaleSprite) * PIC_Y, SRCCOPY)
Else
    Call BitBlt(Picpic.hDC, 0, 0, PIC_X, PIC_Y, Picsprites.hDC, animi * PIC_X, Int(Class(0).FemaleSprite) * PIC_Y, SRCCOPY)
End If
End Sub
