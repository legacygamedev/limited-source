...
'Public Const GAME_PORT = 25050
'Public Const GAME_IP = "deloriawebserver2.no-ip.org"
...
Public Const ITEM_TYPE_RINGS = 18
Public Const ITEM_TYPE_AMULETS = 19
...
Type BattleMsgRec
    ...
    y As Long
End Type
Public BattleMsg(1 To MAX_BLT_LINE) As BattleMsgRec

Type PartyMemsRec
    name As String
    y As Long
End Type
Public PartyMems(0 To MAX_PARTY_MEMS) As PartyMemsRec
...
Public Function ConfigMaps(Optional ByVal DriveLetter As String) As Long
