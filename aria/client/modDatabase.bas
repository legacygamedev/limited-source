...
Sub SetWndAlpha(f As Form, Alpha As Integer)
    Dim lStyle As Long
    
    lStyle = GetWindowLong(f.hwnd, GWL_EXSTYLE)
    lStyle = lStyle Or WS_EX_LAYERED
    SetWindowLong f.hwnd, GWL_EXSTYLE, lStyle
    SetLayeredWindowAttributes f.hwnd, 0, Alpha, LWA_ALPHA
End Sub
