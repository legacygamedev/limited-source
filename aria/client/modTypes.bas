...
Public MAX_FORMS As Long
Public MAX_OBJECTS As Long
...
Public CustomForm() As New frmCustom
...
Public DropSnow() As DropSnowRec
...
Function SetPlayerMaxHP(ByVal Index As Long, ByVal MaxHP As Long) As Long
    Player(Index).MaxHP = MaxHP
End Function
