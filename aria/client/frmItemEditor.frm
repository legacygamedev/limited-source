...
Begin VB.Form frmItemEditor 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "frmItemEditor.frx":1071
      ...
      Begin VB.Frame fraBow 
         ...
         Begin VB.ComboBox cmbBow 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmItemEditor.frx":108D
            Left            =   120
            List            =   "frmItemEditor.frx":108F
            Style           =   2  'Dropdown List
            TabIndex        =   73
            Top             =   600
            Width           =   2295
...
Private Sub cmbType_Click()
    ...
    If (cmbType.ListIndex >= ITEM_TYPE_POTIONADDHP) And (cmbType.ListIndex <= ITEM_TYPE_POTIONSUBMP) Then
    ...
    If (cmbType.ListIndex = ITEM_TYPE_LAMP) Then
        fraSpell.Visible = False
        fraAttributes.Visible = False
        fraEquipment.Visible = False
        fraBow.Visible = False
