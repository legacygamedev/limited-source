...
On Error GoTo Hell
    SetupDX7Sound Me
    SoundDir App.Path & "\SFX"
    CreateBuffers cSoundBuffers, "miss.wav"
    DirectSoundLoaded = True
    Exit Sub

Hell:
    DirectSoundLoaded = False
End Sub
...
Private Sub Status_Timer()
    ...
    If ConnectToServer = True Then
        Label1.Visible = (AutoLogin = 1)
        frmChars.Label1.Visible = (AutoLogin = 1)
        lblss.Caption = "Server Status : Online"
        lblss.ForeColor = RGB(0, 128, 0)
    Else
        Label1.Visible = False
        frmChars.Label1.Visible = False
        lblss.Caption = "Server Status : Offline"
        lblss.ForeColor = vbRed
    End If
