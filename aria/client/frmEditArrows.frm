...
Begin VB.Form frmEditArrows 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Tab(0).Control(4)=   "lblAmmo"
      Tab(0).Control(4).Enabled=   0   'False
      Tab(0).Control(5)=   "Command1"
      Tab(0).Control(5).Enabled=   0   'False
      Tab(0).Control(6)=   "cmdOk"
      Tab(0).Control(6).Enabled=   0   'False
      Tab(0).Control(7)=   "scrlArrow"
      Tab(0).Control(7).Enabled=   0   'False
      Tab(0).Control(8)=   "Picture1"
      Tab(0).Control(8).Enabled=   0   'False
      Tab(0).Control(9)=   "scrlRange"
      Tab(0).Control(9).Enabled=   0   'False
      Tab(0).Control(10)=   "txtName"
      Tab(0).Control(10).Enabled=   0   'False
      Tab(0).Control(11)=   "scrlAmount"
      Tab(0).Control(11).Enabled=   0   'False
      Tab(0).Control(12)=   "scrAmmo"
      Tab(0).Control(12).Enabled=   0   'False
      Tab(0).ControlCount=   13
      Begin VB.HScrollBar scrAmmo 
         Height          =   255
         Left            =   120
         Max             =   500
         TabIndex        =   15
...
Private Sub scrAmmo_Change()
    If scrAmmo.Value > 0 Then
        lblAmmo.Caption = "Ammo: " & scrAmmo.Value & " - " & Item(scrAmmo.Value).Name
    Else
        lblAmmo.Caption = "Ammo: None"
    End If
End Sub
...
Dim Rec2 As RECT
    ...
    Rec1.Left = 0
    Rec1.Top = scrlArrow.Value * PIC_Y
    Rec1.Right = 32
    Rec1.Bottom = Rec1.Top + PIC_Y
    
    Rec2.Bottom = 32
    Rec2.Right = 32
    
    Call DD_ArrowAnim.BltToDC(picArrow.hDC, Rec1, Rec2)
End Sub
