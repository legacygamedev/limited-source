...
Dim Ending As String
    ...
    Next i
    If ReadINI("Config", "ShowEmail", "config.ini") = "0" Then
        txtEmail.Text = "no-email@none.com"
        txtEmail.Visible = False
        lblEmail.Visible = False
        picConnect.Top = lblEmail.Top
        picConnect.Left = lblEmail.Left
    End If
End Sub
...
Dim i As Long
    ...
    If Trim(txtName.Text) <> "" And Trim(txtPassword.Text) <> "" And Trim(txtPassword2.Text) <> "" Then
        ...
        If InStr(Trim(txtEmail.Text), "@") = 0 Or InStr(Trim(txtEmail.Text), ".") = 0 Or Len(Trim(txtEmail.Text)) < 5 Then
