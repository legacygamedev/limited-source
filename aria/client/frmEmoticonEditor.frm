...
Dim Rec2 As RECT
    ...
    Rec1.Left = AnimValue * 32
    Rec1.Top = scrlEmoticon.Value * PIC_Y
    Rec1.Right = Rec1.Left + PIC_X
    Rec1.Bottom = Rec1.Top + PIC_Y
    
    Rec2.Bottom = 32
    Rec2.Right = 32
    
    Call DD_ArrowAnim.BltToDC(picEmoticons.hDC, Rec1, Rec2)
End Sub
...
Dim Rec2 As RECT
    ...
    If AnimValue > 10 Then AnimValue = 0
