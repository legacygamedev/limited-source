   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.ComboBox cmbLight 
            ...
            Left            =   240
            List            =   "frmMapProperties.frx":103B
            Style           =   2  'Dropdown List
            TabIndex        =   58
            Top             =   1560
            Width           =   1335
      ...
      Begin VB.ComboBox cmbNpc 
         ...
         Height          =   315
         Index           =   3
         ItemData        =   "frmMapProperties.frx":105C
         Left            =   -74880
         List            =   "frmMapProperties.frx":105E
         Style           =   2  'Dropdown List
         TabIndex        =   12
         Top             =   1320
         Width           =   4095
      ...
      Begin VB.ComboBox cmbNpc 
         ...
         Height          =   315
         Index           =   7
         ItemData        =   "frmMapProperties.frx":1060
         Left            =   -74880
         List            =   "frmMapProperties.frx":1062
         Style           =   2  'Dropdown List
         TabIndex        =   8
         Top             =   2760
         Width           =   4095
      ...
      Begin VB.ComboBox cmbNpc 
         ...
         Height          =   315
         Index           =   13
         ItemData        =   "frmMapProperties.frx":1064
         Left            =   -74880
         List            =   "frmMapProperties.frx":1066
         Style           =   2  'Dropdown List
         TabIndex        =   2
         Top             =   4920
         Width           =   4095
...
Dim X As Long, Y As Long, i As Long
    ...
    cmbLight.ListIndex = Int(Map(GetPlayerMap(MyIndex)).Indoors)
...
Dim X As Long, Y As Long, i As Long
    ...
    Map(GetPlayerMap(MyIndex)).Indoors = Val(cmbLight.ListIndex)
