...
Sub UpdateCaption()
    frmServer.Caption = GAME_NAME & " - Eight Destinies Server - "
...
Select Case LCase(Parse(0))
                ...
                Case ITEM_TYPE_ARMOR
                    If InvNum <> GetPlayerArmorSlot(index) Then
                        ...
                        If Int(GetPlayerSTR(index)) < n1 Then
                            Call PlayerMsg(index, "Your STR is too low to equip this item!  Required STR (" & n1 & ")", BrightRed)
                            Exit Sub
                        ElseIf Int(GetPlayerDEF(index)) < n2 Then
                            Call PlayerMsg(index, "Your CON is too low to equip this item!  Required CON (" & n2 & ")", BrightRed)
                            Exit Sub
                        ElseIf Int(GetPlayerSPEED(index)) < n3 Then
                            Call PlayerMsg(index, "Your DEX is too low to equip this item!  Required DEX (" & n3 & ")", BrightRed)
                            Exit Sub
                        ElseIf Int(GetPlayerMAGI(index)) < n6 Then
                            Call PlayerMsg(index, "Your INT is too low to equip this item!  Required INT (" & n6 & ")", BrightRed)
                            Exit Sub
                        ElseIf Int(GetPlayerLevel(index)) < n7 Then
                            Call PlayerMsg(index, "Your Level is too low to equip this item!  Required Level (" & n7 & ")", BrightRed)
                            Exit Sub
                        End If
                    ...
                    If Map(GetPlayerMap(index)).Tile(x, y).Type = TILE_TYPE_KEY Then
                        ...
                        If GetPlayerInvItemNum(index, InvNum) = Map(GetPlayerMap(index)).Tile(x, y).Data1 Then
                            ...
                            If Map(GetPlayerMap(index)).Tile(x, y).Data2 = 1 Then
                                ...
                                Call PlayerMsg(index, "The key dissolves.", Yellow)
                            End If
                        End If
                    End If
            ...
            If i <> index Then
                ...
                If CanAttackPlayer(index, i) Then
                    If CanPlayerDodgeHit(i) Then
                        Call BattleMsg(index, GetPlayerName(i) & " dodged your hit!", Yellow, 0)
                        Call BattleMsg(i, "You dodged " & GetPlayerName(index) & "'s hit!", Yellow, 1)
                    End If
                    If Not CanPlayerBlockHit(i) Then
                        ...
                        End If
                            ...
                            Damage = Damage + d7
                            Damage = Damage + d8
                            Call BattleMsg(index, "Critical Hit!", Yellow, 0)
                            Call BattleMsg(i, GetPlayerName(index) & " swings with enormous might!", Yellow, 1)
                        ...
                        End If
                    Else
                        Call BattleMsg(index, GetPlayerName(i) & " blocked your hit!", Yellow, 0)
                        Call BattleMsg(i, "You blocked " & GetPlayerName(index) & "'s hit!", Yellow, 1)
    ...
    Case "playerinforequest"
        ...
        i = FindPlayer(Name)
        If i > 0 Then
            Call PlayerMsg(index, "Account: " & Trim(Player(i).Login) & ", Name: " & GetPlayerName(i), Yellow)
            If GetPlayerAccess(index) > ADMIN_MONITER Then
                Call PlayerMsg(index, "-=- Stats for " & GetPlayerName(i) & " -=-", Yellow)
                Call PlayerMsg(index, "Level: " & GetPlayerLevel(i) & "  Exp: " & GetPlayerExp(i) & "/" & GetPlayerNextLevel(i), Yellow)
                ...
                If o > 100 Then o = 100
                If l > 100 Then l = 100
                Call PlayerMsg(index, "Critical Hit Chance: " & n & "%, Block Chance: " & i & "%", Yellow)
                Call PlayerMsg(index, "Dodge Chance: " & o & "%, Focus Chance: " & l & "%", Yellow)
            End If
        Else
            Call PlayerMsg(index, "Player is not online.", White)
        End If
    ...
    ' ::::::::::::::::::::::::::
    Case "getstats"
        Call PlayerMsg(index, "-=- Stats for " & GetPlayerName(index) & " -=-", Yellow)
        Call PlayerMsg(index, "Level: " & GetPlayerLevel(index) & "  Exp: " & GetPlayerExp(index) & "/" & GetPlayerNextLevel(index), Yellow)
        ...
        Call PlayerMsg(index, "STR: " & GetPlayerSTR(index) & "  CON: " & GetPlayerDEF(index) & "  INT: " & GetPlayerMAGI(index) & "  DEX: " & GetPlayerSPEED(index), Yellow)
    ...
    Case "fixitem"
        ...
        If Item(GetPlayerInvItemNum(index, n)).Type < ITEM_TYPE_GLOVES Or Item(GetPlayerInvItemNum(index, n)).Type > ITEM_TYPE_AMULET Then
            Call PlayerMsg(index, "You can not repair this item.", BrightRed)
            Exit Sub
        End If
        End If
    ...
    Case "pptrade"
        ...
        If CanTrade = True Then
            ...
            Call PlayerMsg(n, GetPlayerName(index) & " would like to trade with you.  Type /accept to accept, or /decline to decline.", Pink)
        ...
        If n = TARGET_TYPE_PLAYER Then
            ...
            If z <> index Then
                ...
                If CanAttackPlayerWithArrow(index, z) Then
                    ...
                    Call BattleMsg(index, GetPlayerName(z) & " dodged your hit!", Yellow, 0)
                    Call BattleMsg(z, "You dodged " & GetPlayerName(index) & "'s hit!", Yellow, 1)
                    End If
                    If Not CanPlayerBlockHit(z) Then
                        ...
                        End If
                            ...
                            Damage = Damage + d8
                            Call BattleMsg(index, "Critical Hit!", Yellow, 0)
                            Call BattleMsg(z, GetPlayerName(index) & " shoots With amazing accuracy!", Yellow, 1)
                        ...
                        End If
                    Else
                        Call BattleMsg(index, GetPlayerName(z) & " blocked your hit!", Yellow, 0)
                        Call BattleMsg(z, "You blocked " & GetPlayerName(index) & "'s hit!", Yellow, 1)
