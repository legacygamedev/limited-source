    ...
    If GlovesSlot > 0 Then
        ...
        If GetPlayerInvItemDur(index, GlovesSlot) > -1 Then
            ...
            If GetPlayerInvItemDur(index, GlovesSlot) <= 0 Then
                Call BattleMsg(index, "Your " & Trim(Item(GetPlayerInvItemNum(index, GlovesSlot)).Name) & " has broken.", Yellow, 0)
                Call TakeItem(index, GetPlayerInvItemNum(index, GlovesSlot), 0)
            Else
                If GetPlayerInvItemDur(index, GlovesSlot) <= 20 Then
                    Call BattleMsg(index, "Your " & Trim(Item(GetPlayerInvItemNum(index, GlovesSlot)).Name) & " is about to break! Dur: " & GetPlayerInvItemDur(index, GlovesSlot) & "/" & Trim(Item(GetPlayerInvItemNum(index, GlovesSlot)).Data1), Yellow, 0)
                End If
            End If
        End If
    End If
    ...
    If BootsSlot > 0 Then
        ...
        If GetPlayerInvItemDur(index, BootsSlot) > -1 Then
            ...
            If GetPlayerInvItemDur(index, BootsSlot) <= 0 Then
                Call BattleMsg(index, "Your " & Trim(Item(GetPlayerInvItemNum(index, BootsSlot)).Name) & " has broken.", Yellow, 0)
                Call TakeItem(index, GetPlayerInvItemNum(index, BootsSlot), 0)
            Else
                If GetPlayerInvItemDur(index, BootsSlot) <= 20 Then
                    Call BattleMsg(index, "Your " & Trim(Item(GetPlayerInvItemNum(index, BootsSlot)).Name) & " is about to break! Dur: " & GetPlayerInvItemDur(index, BootsSlot) & "/" & Trim(Item(GetPlayerInvItemNum(index, BootsSlot)).Data1), Yellow, 0)
                End If
            End If
        End If
    End If
    ...
    If BeltSlot > 0 Then
        ...
        If GetPlayerInvItemDur(index, BeltSlot) > -1 Then
            ...
            If GetPlayerInvItemDur(index, BeltSlot) <= 0 Then
                Call BattleMsg(index, "Your " & Trim(Item(GetPlayerInvItemNum(index, BeltSlot)).Name) & " has broken.", Yellow, 0)
                Call TakeItem(index, GetPlayerInvItemNum(index, BeltSlot), 0)
            Else
                If GetPlayerInvItemDur(index, BeltSlot) <= 20 Then
                    Call BattleMsg(index, "Your " & Trim(Item(GetPlayerInvItemNum(index, BeltSlot)).Name) & " is about to break! Dur: " & GetPlayerInvItemDur(index, BeltSlot) & "/" & Trim(Item(GetPlayerInvItemNum(index, BeltSlot)).Data1), Yellow, 0)
                End If
            End If
        End If
    End If
    ...
    If AmuletSlot > 0 Then
        ...
        If GetPlayerInvItemDur(index, AmuletSlot) > -1 Then
            ...
            If GetPlayerInvItemDur(index, AmuletSlot) <= 0 Then
                Call BattleMsg(index, "Your " & Trim(Item(GetPlayerInvItemNum(index, AmuletSlot)).Name) & " has broken.", Yellow, 0)
                Call TakeItem(index, GetPlayerInvItemNum(index, AmuletSlot), 0)
            Else
                If GetPlayerInvItemDur(index, AmuletSlot) <= 20 Then
                    Call BattleMsg(index, "Your " & Trim(Item(GetPlayerInvItemNum(index, AmuletSlot)).Name) & " is about to break! Dur: " & GetPlayerInvItemDur(index, AmuletSlot) & "/" & Trim(Item(GetPlayerInvItemNum(index, AmuletSlot)).Data1), Yellow, 0)
                End If
            End If
        End If
    End If
...
Dim AttackSpeed As Long
    ...
    If GetPlayerSP(Attacker) < 1 Then
        Call BattleMsg(Attacker, "Not enough stamina!", BrightRed, 0)
        Exit Function
    End If
                                    ...
                                    Else
                                        ...
                                        Else
                                            If Trim(GetPlayerGuild(Attacker)) <> "" And GetPlayerGuild(Victim) <> "" Then
                                                ...
                                                Else
                                                    Call PlayerMsg(Attacker, "You can't attack a guild member!", BrightRed)
                                                End If
                                            Else
                                                CanAttackPlayer = True
                                            End If
        ...
        If Map(GetPlayerMap(Victim)).Moral <> MAP_MORAL_NO_PENALTY Then
         ...
         '       End If
            ...
            If GetPlayerLevel(Victim) = MAX_LEVEL Then
                Call BattleMsg(Victim, "You can't lose any experience!", BrightRed, 1)
...
Dim STR As Long, DEF As Long, FireSTR As Long, FireDEF As Long, WaterSTR As Long, WaterDEF As Long, EarthSTR As Long, EarthDEF As Long, AirSTR As Long, AirDEF As Long, HeatSTR As Long, HeatDEF As Long, ColdSTR As Long, ColdDEF As Long, LightSTR As Long, LightDEF As Long, DarkSTR As Long, DarkDEF As Long, MapNum As Long, NpcNum As Long
    ...
    If Damage >= MapNpc(MapNum, MapNpcNum).HP Then
        ...
        Call BattleMsg(Attacker, "You killed: " & Name, BrightRed, 0)
        ...
        If Player(Attacker).InParty = False Or Player(Attacker).Party.ShareExp = False Then
            If GetPlayerLevel(Attacker) = MAX_LEVEL Then
                ...
                Call BattleMsg(Attacker, "You can't gain anymore experience!", BrightGreen, 0)
            Else
                Call SetPlayerExp(Attacker, GetPlayerExp(Attacker) + Exp)
                Call BattleMsg(Attacker, "You have gained " & Exp & " experience.", BrightGreen, 0)
            End If
        Else
            q = 0
                    ...
                    If Player(Attacker).Party.Member(x) > 0 Then
                        If Player(Player(Attacker).Party.Member(x)).Party.ShareExp = True Then
                            If GetPlayerLevel(Player(Attacker).Party.Member(x)) = MAX_LEVEL Then
                                ...
                                Call BattleMsg(Player(Attacker).Party.Member(x), "You can't gain anymore experience!", BrightGreen, 0)
                            Else
                                Call SetPlayerExp(Player(Attacker).Party.Member(x), GetPlayerExp(Player(Attacker).Party.Member(x)) + Exp)
                                Call BattleMsg(Player(Attacker).Party.Member(x), "You have gained " & Exp & " party experience.", BrightGreen, 0)
                            End If
                        End If
                    End If
                Next x
    ...
    Else
        ...
        ' Check for a weapon and say damage
        Call BattleMsg(Attacker, "You hit: " & Name & ", for " & Damage & " damage.", White, 0)
