...
Public Const MAX_INV = 36
Public Const MAX_BANK = 100
Public Const MAX_MAP_NPCS = 30
Public Const MAX_PLAYER_SPELLS = 40
Public Const MAX_TRADES = 60
Public Const MAX_PLAYER_TRADES = 8
Public Const MAX_NPC_DROPS = 30
...
Public Const MAX_CHARS = 4

' Basic Security Passwords, You cant connect without it
Public Const SEC_CODE1 = "jwehiehfojcvnvnsdinaoiwheoewyriusdyrflsdjncjkxzncisdughfusyfuapsipiuahfpaijnflkjnvjnuahguiryasbdlfkjblsahgfauygewuifaunfauk"
...
Public Const TILE_TYPE_ARROWPASS = 21
...
Public Const ITEM_TYPE_POTIONADDHP = 6
Public Const ITEM_TYPE_POTIONADDMP = 7
Public Const ITEM_TYPE_POTIONADDSP = 8
Public Const ITEM_TYPE_POTIONSUBHP = 9
Public Const ITEM_TYPE_POTIONSUBMP = 10
Public Const ITEM_TYPE_POTIONSUBSP = 11
Public Const ITEM_TYPE_KEY = 12
Public Const ITEM_TYPE_CURRENCY = 13
Public Const ITEM_TYPE_SPELL = 14
Public Const ITEM_TYPE_GLOVES = 15
Public Const ITEM_TYPE_BOOTS = 16
Public Const ITEM_TYPE_BELT = 17
Public Const ITEM_TYPE_LEGS = 18
Public Const ITEM_TYPE_RING = 19
Public Const ITEM_TYPE_AMULET = 20
...
Dim n As Long
    ...
    For i = 1 To MAX_CHARS
        ...
        Player(index).Char(i).BeltSlot = 0
...
Dim n As Long
    ...
    Player(index).Char(CharNum).BeltSlot = 0
...
Sub ClearItem(ByVal index As Long)
    ...
    Item(index).FireSTR = 0
    Item(index).FireDEF = 0
    Item(index).WaterSTR = 0
    Item(index).WaterDEF = 0
    Item(index).EarthSTR = 0
    Item(index).EarthDEF = 0
    Item(index).AirSTR = 0
    Item(index).AirDEF = 0
    Item(index).HeatSTR = 0
    Item(index).HeatDEF = 0
    Item(index).ColdSTR = 0
    Item(index).ColdDEF = 0
    Item(index).LightSTR = 0
    Item(index).LightDEF = 0
    Item(index).DarkSTR = 0
    Item(index).DarkDEF = 0
    Item(index).AddHP = 0
    Item(index).AddMP = 0
    Item(index).AddSP = 0
    Item(index).AddStr = 0
...
Dim i As Long
    ...
    Npc(index).FireSTR = 0
    Npc(index).FireDEF = 0
    Npc(index).WaterSTR = 0
    Npc(index).WaterDEF = 0
    Npc(index).EarthSTR = 0
    Npc(index).EarthDEF = 0
    Npc(index).AirSTR = 0
    Npc(index).AirDEF = 0
    Npc(index).HeatSTR = 0
    Npc(index).HeatDEF = 0
    Npc(index).ColdSTR = 0
    Npc(index).ColdDEF = 0
    Npc(index).LightSTR = 0
    Npc(index).LightDEF = 0
    Npc(index).DarkSTR = 0
    Npc(index).DarkDEF = 0
    Npc(index).Speed = 0
    Npc(index).Magi = 0
...
Sub ClearSpell(ByVal index As Long)
    ...
    Spell(index).Type = 0
    Spell(index).Data1 = 0
    Spell(index).FireSTR = 0
    Spell(index).WaterSTR = 0
    Spell(index).EarthSTR = 0
    Spell(index).AirSTR = 0
    Spell(index).HeatSTR = 0
    Spell(index).ColdSTR = 0
    Spell(index).LightSTR = 0
    Spell(index).DarkSTR = 0
    Spell(index).Data2 = 0
    Spell(index).Data3 = 0
...
add = 0
    ...
    If GetPlayerBeltSlot(index) > 0 Then
        add = add + Item(GetPlayerInvItemNum(index, GetPlayerBeltSlot(index))).AddHP
    End If
...
add = 0
    ...
    End If
    If GetPlayerBeltSlot(index) > 0 Then
        add = add + Item(GetPlayerInvItemNum(index, GetPlayerBeltSlot(index))).AddMP
    End If
    If GetPlayerLegsSlot(index) > 0 Then
...
add = 0
    ...
    End If
    If GetPlayerBeltSlot(index) > 0 Then
        add = add + Item(GetPlayerInvItemNum(index, GetPlayerBeltSlot(index))).AddSP
    End If
    If GetPlayerLegsSlot(index) > 0 Then
...
add = 0
    ...
    End If
    If GetPlayerBeltSlot(index) > 0 Then
        add = add + Item(GetPlayerInvItemNum(index, GetPlayerBeltSlot(index))).AddStr
    End If
    If GetPlayerLegsSlot(index) > 0 Then
...
add = 0
    ...
    End If
    If GetPlayerBeltSlot(index) > 0 Then
        add = add + Item(GetPlayerInvItemNum(index, GetPlayerBeltSlot(index))).AddDef
    End If
    If GetPlayerLegsSlot(index) > 0 Then
...
add = 0
    ...
    End If
    If GetPlayerBeltSlot(index) > 0 Then
        add = add + Item(GetPlayerInvItemNum(index, GetPlayerBeltSlot(index))).AddSpeed
    End If
    If GetPlayerLegsSlot(index) > 0 Then
...
add = 0
    ...
    End If
    If GetPlayerBeltSlot(index) > 0 Then
        add = add + Item(GetPlayerInvItemNum(index, GetPlayerBeltSlot(index))).AddMagi
    End If
    If GetPlayerLegsSlot(index) > 0 Then
