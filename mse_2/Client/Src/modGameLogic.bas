...
Dim rec_back As RECT
    ...
    ' Set the focus
    'frmMirage.picScreen.SetFocus <- Removed: gives error on slow computers, visit for info: http://www.key2heaven.net/ms/forums/viewtopic.php?t=747
    ...
    Do While InGame
        ...
        MyText = frmMirage.txtMyChat.Text
        frmMirage.txtMyChat.Text = MyText
