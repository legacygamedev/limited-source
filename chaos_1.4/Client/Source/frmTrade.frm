...
Dim Selected As Long
    ...
    If Trade(Selected).Items(Trade(Selected).SelectedItem).ItemGetNum > 0 Then
        Call SendData("traderequest" & SEP_CHAR & Selected & SEP_CHAR & Trade(Selected).SelectedItem & SEP_CHAR & ShopNum & SEP_CHAR & END_CHAR)
    End If
End Sub
...
Selected = 0
    ...
    For I = 1 To MAX_TRADES
        ...
        If Trade(Selected).Items(I).ItemGetNum > 0 Then
            Call BitBlt(picItem(I - 1).hDC, 0, 0, PIC_X, PIC_Y, frmMirage.picItems.hDC, (pic - Int(pic / 6) * 6) * PIC_X, Int(pic / 6) * PIC_Y, SRCCOPY)
        Else
    ...
    If Trade(Selected).Items(Trade(Selected).SelectedItem).ItemGiveNum > 0 Then
        Call BitBlt(picItem(66).hDC, 0, 0, PIC_X, PIC_Y, frmMirage.picItems.hDC, (pic - Int(pic / 6) * 6) * PIC_X, Int(pic / 6) * PIC_Y, SRCCOPY)
    End If
End Sub
