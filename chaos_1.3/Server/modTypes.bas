...
Type PlayerRec
    ...
    TotalKills As Long
    TotalKillsSame As Long
    TotalKillsOpposite As Long
    TotalKillsDefense As Long
End Type
...
Function GetPlayerTotalKills(ByVal Index As Long) As Long
    GetPlayerTotalKills = Player(Index).Char(Player(Index).CharNum).TotalKills
End Function

Sub AddPlayerTotalKills(ByVal Index As Long)
Dim b As Long
b = GetPlayerTotalKills(Index)
    Player(Index).Char(Player(Index).CharNum).TotalKills = b + 1
End Sub

Function GetPlayerTotalKillsOpposite(ByVal Index As Long) As Long
    GetPlayerTotalKillsOpposite = Player(Index).Char(Player(Index).CharNum).TotalKillsOpposite
End Function

Sub AddPlayerTotalKillsOpposite(ByVal Index As Long)
Dim b As Long
b = GetPlayerTotalKillsOpposite(Index)
    Player(Index).Char(Player(Index).CharNum).TotalKillsOpposite = b + 1
End Sub

Function GetPlayerTotalKillsDefense(ByVal Index As Long) As Long
    GetPlayerTotalKillsDefense = Player(Index).Char(Player(Index).CharNum).TotalKillsDefense
End Function

Sub AddPlayerTotalKillsDefense(ByVal Index As Long)
Dim b As Long
b = GetPlayerTotalKillsDefense(Index)
    Player(Index).Char(Player(Index).CharNum).TotalKillsDefense = b + 1
End Sub

Function GetPlayerTotalKillsSame(ByVal Index As Long) As Long
    GetPlayerTotalKillsSame = Player(Index).Char(Player(Index).CharNum).TotalKillsSame
End Function

Sub AddPlayerTotalKillsSame(ByVal Index As Long)
Dim b As Long
b = GetPlayerTotalKillsSame(Index)
    Player(Index).Char(Player(Index).CharNum).TotalKillsSame = b + 1
End Sub
