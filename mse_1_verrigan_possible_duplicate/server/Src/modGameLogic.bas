...
Dim WeaponSlot As Long
    ...
    If GetPlayerWeaponSlot(Index) > 0 Then
        ...
        If GetPlayerInvItemDur(Index, WeaponSlot) <= 0 Then
            Call PlayerMsg(Index, "Your " & Trim(StrConv(Item(GetPlayerInvItemNum(Index, WeaponSlot)).ItemName, vbUnicode)) & " has broken.", Yellow)
            Call TakeItem(Index, GetPlayerInvItemNum(Index, WeaponSlot), 0)
        Else
            If GetPlayerInvItemDur(Index, WeaponSlot) <= 5 Then
                Call PlayerMsg(Index, "Your " & Trim(StrConv(Item(GetPlayerInvItemNum(Index, WeaponSlot)).ItemName, vbUnicode)) & " is about to break!", Yellow)
            End If
        End If
    End If
End Function
...
Dim ArmorSlot As Long, HelmSlot As Long
    ...
    If ArmorSlot > 0 Then
        ...
        If GetPlayerInvItemDur(Index, ArmorSlot) <= 0 Then
            Call PlayerMsg(Index, "Your " & Trim(StrConv(Item(GetPlayerInvItemNum(Index, ArmorSlot)).ItemName, vbUnicode)) & " has broken.", Yellow)
            Call TakeItem(Index, GetPlayerInvItemNum(Index, ArmorSlot), 0)
        Else
            If GetPlayerInvItemDur(Index, ArmorSlot) <= 5 Then
                Call PlayerMsg(Index, "Your " & Trim(StrConv(Item(GetPlayerInvItemNum(Index, ArmorSlot)).ItemName, vbUnicode)) & " is about to break!", Yellow)
            End If
        End If
    End If
    ...
    If HelmSlot > 0 Then
        ...
        If GetPlayerInvItemDur(Index, HelmSlot) <= 0 Then
            Call PlayerMsg(Index, "Your " & Trim(StrConv(Item(GetPlayerInvItemNum(Index, HelmSlot)).ItemName, vbUnicode)) & " has broken.", Yellow)
            Call TakeItem(Index, GetPlayerInvItemNum(Index, HelmSlot), 0)
        Else
            If GetPlayerInvItemDur(Index, HelmSlot) <= 5 Then
                Call PlayerMsg(Index, "Your " & Trim(StrConv(Item(GetPlayerInvItemNum(Index, HelmSlot)).ItemName, vbUnicode)) & " is about to break!", Yellow)
            End If
        End If
    End If
End Function
            ...
            If (MapItem(MapNum, i).x = GetPlayerX(Index)) And (MapItem(MapNum, i).y = GetPlayerY(Index)) Then
                ...
                If n <> 0 Then
                    ...
                    If Item(GetPlayerInvItemNum(Index, n)).Type = ITEM_TYPE_CURRENCY Then
                        ...
                        Msg = "You picked up " & MapItem(MapNum, i).Value & " " & Trim(StrConv(Item(GetPlayerInvItemNum(Index, n)).ItemName, vbUnicode)) & "."
                    Else
                        Call SetPlayerInvItemValue(Index, n, 0)
                        Msg = "You picked up a " & Trim(StrConv(Item(GetPlayerInvItemNum(Index, n)).ItemName, vbUnicode)) & "."
                    End If
        ...
        If i <> 0 Then
            ...
            If Item(GetPlayerInvItemNum(Index, InvNum)).Type = ITEM_TYPE_CURRENCY Then
                ...
                If Ammount >= GetPlayerInvItemValue(Index, InvNum) Then
                    ...
                    Call MapMsg(GetPlayerMap(Index), GetPlayerName(Index) & " drops " & GetPlayerInvItemValue(Index, InvNum) & " " & Trim(StrConv(Item(GetPlayerInvItemNum(Index, InvNum)).ItemName, vbUnicode)) & ".", Yellow)
                    Call SetPlayerInvItemNum(Index, InvNum, 0)
                    Call SetPlayerInvItemValue(Index, InvNum, 0)
                    Call SetPlayerInvItemDur(Index, InvNum, 0)
                Else
                    MapItem(GetPlayerMap(Index), i).Value = Ammount
                    Call MapMsg(GetPlayerMap(Index), GetPlayerName(Index) & " drops " & Ammount & " " & Trim(StrConv(Item(GetPlayerInvItemNum(Index, InvNum)).ItemName, vbUnicode)) & ".", Yellow)
            ...
            Else
                ...
                If Item(GetPlayerInvItemNum(Index, InvNum)).Type >= ITEM_TYPE_WEAPON And Item(GetPlayerInvItemNum(Index, InvNum)).Type <= ITEM_TYPE_SHIELD Then
                    Call MapMsg(GetPlayerMap(Index), GetPlayerName(Index) & " drops a " & Trim(StrConv(Item(GetPlayerInvItemNum(Index, InvNum)).ItemName, vbUnicode)) & " " & GetPlayerInvItemDur(Index, InvNum) & "/" & Item(GetPlayerInvItemNum(Index, InvNum)).Data1 & ".", Yellow)
                Else
                    Call MapMsg(GetPlayerMap(Index), GetPlayerName(Index) & " drops a " & Trim(StrConv(Item(GetPlayerInvItemNum(Index, InvNum)).ItemName, vbUnicode)) & ".", Yellow)
                End If
...
Dim i As Long
    ...
    If Damage >= GetPlayerHP(Victim) Then
        ...
        Else
            Call PlayerMsg(Attacker, "You hit " & GetPlayerName(Victim) & " with a " & Trim(StrConv(Item(n).ItemName, vbUnicode)) & " for " & Damage & " hit points.", White)
            Call PlayerMsg(Victim, GetPlayerName(Attacker) & " hit you with a " & Trim(StrConv(Item(n).ItemName, vbUnicode)) & " for " & Damage & " hit points.", BrightRed)
        End If
...
Dim STR As Long, DEF As Long, MapNum As Long, NpcNum As Long
    ...
    If Damage >= MapNpc(MapNum, MapNpcNum).HP Then
        ...
        Else
            Call PlayerMsg(Attacker, "You hit a " & Name & " with a " & Trim(StrConv(Item(n).ItemName, vbUnicode)) & " for " & Damage & " hit points, killing it.", BrightRed)
        End If
    ...
    Else
        ...
        Else
            Call PlayerMsg(Attacker, "You hit a " & Name & " with a " & Trim(StrConv(Item(n).ItemName, vbUnicode)) & " for " & Damage & " hit points.", White)
        End If
...
Sub ClearPlayer(ByVal Index As Long)
  Dim tAccountRec As AccountRec 'Need object to obtain memory size.
  Dim tLen As Long
  
  tLen = LenB(tAccountRec)
  Call FillMemory(ByVal VarPtr(Player(Index)), tLen, 0)
  Player(Index).Buffer = ""
  Player(Index).Login = ""
...
Dim y As Long
    ...
    Call FillMemory(Map(MapNum).MapName(0), aLen(Map(MapNum).MapName), 32) 'Fill it with spaces.
...
Function GetClassName(ByVal ClassNum As Long) As String
    GetClassName = Trim(StrConv(Class(ClassNum).ClassName, vbUnicode))
End Function
...
Sub SetPlayerArmorSlot(ByVal Index As Long, ByVal InvNum As Byte)
...
Sub SetPlayerWeaponSlot(ByVal Index As Long, ByVal InvNum As Byte)
...
Sub SetPlayerHelmetSlot(ByVal Index As Long, ByVal InvNum As Byte)
...
Sub SetPlayerShieldSlot(ByVal Index As Long, ByVal InvNum As Byte)
