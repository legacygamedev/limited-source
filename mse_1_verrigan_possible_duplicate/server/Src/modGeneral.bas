                        ...
                        If IsPlaying(Target) And GetPlayerMap(Target) = y Then
                            ...
                            If CanNpcAttackPlayer(x, Target) Then
                                If Not CanPlayerBlockHit(Target) Then
                                    ...
                                    End If
                                Else
                                    Call PlayerMsg(Target, "Your " & Trim(StrConv(Item(GetPlayerInvItemNum(Target, GetPlayerShieldSlot(Target))).ItemName, vbUnicode)) & " blocks the " & Trim(Npc(NpcNum).Name) & "'s hit!", BrightCyan)
                                End If
                            End If
                        Else
