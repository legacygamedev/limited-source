...
Dim x As Long, y As Long, i As Long
    ...
    txtName.Text = Trim(StrConv(Map.MapName, vbUnicode))
...
Dim Buffer() As Byte
    ...
    Buffer = StrConv(txtName.Text, vbFromUnicode)
    ReDim Preserve Buffer(NAME_LENGTH - 1)
    Call FillMemory(Buffer(Len(txtName.Text)), NAME_LENGTH - Len(txtName.Text), 32)
    Call CopyMemory(Map.MapName(0), Buffer(0), NAME_LENGTH)
