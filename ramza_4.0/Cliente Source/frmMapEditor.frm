...
Dim x As Long
    ...
    x = MsgBox("Estas seguro que deseas descartar los cambios?", vbYesNo)
    If x = vbNo Then
        Exit Sub
    End If
...
x = MsgBox("Estas seguro que deseas llenar el mapa?", vbYesNo)
If x = vbNo Then
    Exit Sub
End If
...
Dim x As Long
    ...
    x = MsgBox("Estas seguro que quieres guardar los cambios?", vbYesNo)
    If x = vbNo Then
        Exit Sub
    End If
