...
Private Sub scrlAccessReq_Change()
    With scrlAccessReq
        Select Case .Value
            Case 0
                Label17.Caption = "0 - Cualquiera"
            Case 1
                Label17.Caption = "1 - Moderador"
            Case 2
                Label17.Caption = "2 - Mapeador"
            Case 3
                Label17.Caption = "3 - Desarrolla."
            Case 4
                Label17.Caption = "4 - Administra."
            End Select
    End With
End Sub
