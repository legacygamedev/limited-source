...
Begin VB.Form frmNPCSpawn 
   ...
   Begin VB.Label lblNum3 
      AutoSize        =   -1  'True
      BackStyle       =   0  'Transparent
      Caption         =   "Rango de aparicion por capas: 0"
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   8.25
         Charset         =   0
...
Private Sub scrlNum_Change()
    lblNum.Caption = "NPC Numero: " & scrlNum.Value & " - " & Trim(Npc(scrlNum.Value).Name)
End Sub

Private Sub scrlNum2_Change()
    lblNum2.Caption = "NPC Cantidad: " & scrlNum2.Value
End Sub

Private Sub scrlNum3_Change()
    lblNum3.Caption = "Rango de aparicion por capas: " & scrlNum3.Value
End Sub
