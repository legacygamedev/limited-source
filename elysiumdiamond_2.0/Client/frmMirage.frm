...
Begin VB.Form frmMirage 
   ...
   Begin VB.PictureBox picWhosOnline 
      ...
      Begin VB.ListBox lstOnline 
         ...
         EndProperty
         Height          =   2340
         ItemData        =   "frmMirage.frx":887E91
         Left            =   410
         List            =   "frmMirage.frx":887E93
         TabIndex        =   12
         Top             =   960
         Width           =   2630
      End
   ...
   Begin VB.PictureBox picPlayerSpells 
      ...
      Begin VB.ListBox lstSpells 
         ...
         ForeColor       =   &H00000000&
         Height          =   2340
         ItemData        =   "frmMirage.frx":89DBC5
         Left            =   405
         List            =   "frmMirage.frx":89DBC7
         TabIndex        =   4
         Top             =   960
         Width           =   2655
      End
