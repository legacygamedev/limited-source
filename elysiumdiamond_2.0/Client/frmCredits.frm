...
Dim f As Long
    ...
    txtCredits.Text = "--- Elysium Diamond ---" & vbNewLine & "Made by pingu (pingu@splamm.com)" & vbNewLine & vbNewLine & "Previous versions made by GodSentDeath and Coke" & vbNewLine & vbNewLine & " Special thanks to l4lucas (for the cool map editor), to Johnman (for the SS converter and hosting), and to nex666 for the awesome GUI!" & vbNewLine & vbNewLine & " Elysium Diamond is covered under the EGL license" & vbNewLine & " If you downloaded this software and the owner claims to have made it and he is not pingu or an owner of Elysium Source, please contact pingu (pingu@splamm.com)"
