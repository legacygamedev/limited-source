...
Begin VB.Form frmMirage 
   ...
   Begin VB.PictureBox picPlayerSpells 
      ...
      Begin VB.ListBox lstSpells 
         ...
         ForeColor       =   &H00000000&
         Height          =   2190
         ItemData        =   "frmMirage.frx":3B011
         Left            =   45
         List            =   "frmMirage.frx":3B013
         TabIndex        =   5
         Top             =   60
         Width           =   2535
      End
   ...
   Begin VB.PictureBox picWhosOnline 
      ...
      Begin VB.ListBox lstOnline 
         ...
         EndProperty
         Height          =   2340
         ItemData        =   "frmMirage.frx":3B015
         Left            =   75
         List            =   "frmMirage.frx":3B017
         TabIndex        =   26
         Top             =   75
         Width           =   2460
      End
...
Private Sub picScreen_MouseMove(Button As Integer, Shift As Integer, x As Single, Y As Single)
    ...
    frmHouseEditor.Caption = "Map Editor - " & "X: " & Int((x + (NewPlayerX * PIC_X)) / 32) & " Y: " & Int((Y + (NewPlayerY * PIC_Y)) / 32)
End Sub
