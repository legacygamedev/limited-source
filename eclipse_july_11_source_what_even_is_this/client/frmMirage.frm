...
Begin VB.Form frmMirage 
   ...
   Begin VB.PictureBox picPlayerSpells 
      ...
      Begin VB.ListBox lstSpells 
         ...
         ForeColor       =   &H00000000&
         Height          =   2190
         ItemData        =   "frmMirage.frx":265FC
         Left            =   45
         List            =   "frmMirage.frx":265FE
         TabIndex        =   5
         Top             =   60
         Width           =   2535
      End
   ...
   Begin VB.PictureBox picWhosOnline 
      ...
      Begin VB.ListBox lstOnline 
         ...
         EndProperty
         Height          =   2340
         ItemData        =   "frmMirage.frx":26600
         Left            =   75
         List            =   "frmMirage.frx":26602
         TabIndex        =   26
         Top             =   75
         Width           =   2460
      End
