...
Sub UpdateCaption()
    frmServer.Caption = GAME_NAME & " - Server - Powered By Eclipse"
...
Exit Sub
   ...
   ' End If
    ...
    Case "easteregg"
            Call GlobalMsg("TheYellowMole and Marsh are ubercool! Congrats on finding eclipse's easter egg!", Yellow)
        Exit Sub
