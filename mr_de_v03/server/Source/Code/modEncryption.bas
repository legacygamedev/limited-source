...
Private Const PacketEncKey1 As String = "m,.abnaf%$#-9./,1n/N!24jha-9:[.;'k41J1h4;afs1321l;jDASFJ" 'First encryption key (any string works)
Private Const PacketEncKey2 As String = "ut%4hkjbBAflh.[l';l3423Njklhanf!#9901nj132.1406579-465/45" 'Second encryption key (any string works)
...
'*****************************************************************
    ...
    Encryption_RC4_EncryptByte ByteArray(), Key
...
Dim ByteArray() As Byte
    ...
    If (Not Encryption_Misc_FileExist(SourceFile)) Then
        Err.Raise vbObjectError, , "Error in Skipjack Encryption_RC4_EncryptFile procedure (Source file does not exist)."
        Exit Sub
    End If
    ...
    Encryption_RC4_DecryptByte ByteArray(), Key
...
Dim sBox(0 To 255) As Integer
    ...
    CopyMemory sBox(0), m_sBoxRC4(0), 512
...
'*****************************************************************
    ...
    Encryption_XOR_EncryptByte ByteArray(), Key
...
Dim ByteArray() As Byte
    ...
    'Make sure the source file do exist
    If (Not Encryption_Misc_FileExist(SourceFile)) Then
        Err.Raise vbObjectError, , "Error in Skipjack Encryption_XOR_EncryptFile procedure (Source file does not exist)."
        Exit Sub
    End If
    ...
    'Decrypt the bytearray
    Encryption_XOR_DecryptByte ByteArray(), Key
