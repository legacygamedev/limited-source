...
Begin VB.Form frmShopEditor 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabCaption(6)   =   "Other"
      TabPicture(6)   =   "frmShopEditor.frx":106A
      Tab(6).ControlEnabled=   -1  'True
      Tab(6).Control(0)=   "lstTradeItem(6)"
      ...
      Begin VB.ListBox lstTradeItem 
         ...
         Height          =   2205
         Index           =   6
         ItemData        =   "frmShopEditor.frx":1086
         Left            =   240
         List            =   "frmShopEditor.frx":1088
         TabIndex        =   27
         Top             =   360
         Width           =   4935
      End
      Begin VB.ListBox lstTradeItem 
         ...
         Height          =   2205
         Index           =   5
         ItemData        =   "frmShopEditor.frx":108A
         Left            =   -74760
         List            =   "frmShopEditor.frx":108C
         TabIndex        =   26
         Top             =   360
         Width           =   4935
      End
      Begin VB.ListBox lstTradeItem 
         ...
         Height          =   2205
         Index           =   4
         ItemData        =   "frmShopEditor.frx":108E
         Left            =   -74760
         List            =   "frmShopEditor.frx":1090
         TabIndex        =   25
         Top             =   360
         Width           =   4935
      End
      Begin VB.ListBox lstTradeItem 
         ...
         Height          =   2205
         Index           =   3
         ItemData        =   "frmShopEditor.frx":1092
         Left            =   -74760
         List            =   "frmShopEditor.frx":1094
         TabIndex        =   24
         Top             =   360
         Width           =   4935
      End
      Begin VB.ListBox lstTradeItem 
         ...
         Height          =   2205
         Index           =   2
         ItemData        =   "frmShopEditor.frx":1096
         Left            =   -74760
         List            =   "frmShopEditor.frx":1098
         TabIndex        =   23
         Top             =   360
         Width           =   4935
      End
      Begin VB.ListBox lstTradeItem 
         ...
         Height          =   2205
         Index           =   1
         ItemData        =   "frmShopEditor.frx":109A
         Left            =   -74760
         List            =   "frmShopEditor.frx":109C
         TabIndex        =   22
         Top             =   360
         Width           =   4935
      End
      Begin VB.ListBox lstTradeItem 
         ...
         Height          =   2205
         Index           =   0
         ItemData        =   "frmShopEditor.frx":109E
         Left            =   -74760
         List            =   "frmShopEditor.frx":10A0
         TabIndex        =   21
         Top             =   360
         Width           =   4935
      End
    ...
    If ItemNum > 0 Then
        If i = 1 Then
            ...
            ElseIf Item(ItemNum).Type = ITEM_TYPE_SHIELD Then
                ...
                Exit Sub
            ElseIf Item(ItemNum).Type = ITEM_TYPE_ARMOR Or Item(ItemNum).Type = ITEM_TYPE_LEGS Then
            ...
            ElseIf Item(ItemNum).Type = ITEM_TYPE_SPELL Then
                ...
                Exit Sub
            ElseIf Item(ItemNum).Type = ITEM_TYPE_RING Or Item(ItemNum).Type = ITEM_TYPE_NECKLACE Then
                MsgBox "Please click the tab that says jewels to add this!"
                Exit Sub
            Else
