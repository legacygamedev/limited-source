...
Begin VB.Form frmItemEditor 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "frmItemEditor.frx":10B5
      ...
      Begin VB.Frame fraBow 
         ...
         Begin VB.ComboBox cmbBow 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmItemEditor.frx":10D1
            Left            =   120
            List            =   "frmItemEditor.frx":10D3
            Style           =   2  'Dropdown List
            TabIndex        =   73
            Top             =   600
            Width           =   2295
...
If cmbType.ListIndex = ITEM_TYPE_WEAPON Or cmbType.ListIndex = ITEM_TYPE_RING Or cmbType.ListIndex = ITEM_TYPE_NECKLACE Then
...
Dim uRECT As RECT
    ...
    Call BitBlt(picSelect.hDC, 0, 0, PIC_X, PIC_Y, picItems.hDC, EditorItemX * PIC_X, EditorItemY * PIC_Y, SRCCOPY)
        ...
        If ENCRYPT_TYPE = "BMP" Then
                ...
                frmItemEditor.picBow.Width = BMU.ImageWidth
                frmItemEditor.picBow.Height = BMU.ImageHeight
                Call BMU.Blt(frmItemEditor.picBow.hDC)
                End If
