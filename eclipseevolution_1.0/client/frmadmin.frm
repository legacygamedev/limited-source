...
Begin VB.Form frmadmin 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Tab(2).Control(0)=   "btneditmap"
      Tab(2).Control(1)=   "btneditspell"
      Tab(2).Control(2)=   "btnedititem"
      Tab(2).Control(3)=   "btnEditShops"
      Tab(2).Control(4)=   "tnEditNPC"
      Tab(2).Control(5)=   "tnEditArrow"
      Tab(2).Control(6)=   "tnEditEmoticon"
      Tab(2).Control(7)=   "tnEditElement"
