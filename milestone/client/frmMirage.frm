...
Begin VB.Form frmMirage 
   ...
   Begin VB.PictureBox picInv3 
      ...
      Begin VB.ListBox lstInv 
         ...
         ForeColor       =   &H00000000&
         Height          =   2190
         ItemData        =   "frmMirage.frx":18BEDB
         Left            =   2640
         List            =   "frmMirage.frx":18BEDD
         TabIndex        =   2
         Top             =   2400
         Visible         =   0   'False
         Width           =   2625
   ...
   Begin VB.PictureBox picPlayerSpells 
      ...
      Begin VB.ListBox lstSpells 
         ...
         ForeColor       =   &H00000000&
         Height          =   2190
         ItemData        =   "frmMirage.frx":1A1BB1
         Left            =   45
         List            =   "frmMirage.frx":1A1BB3
         TabIndex        =   6
         Top             =   60
         Width           =   2535
      End
