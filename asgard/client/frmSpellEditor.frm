   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.Label Label11 
            Caption         =   "index in the vital mod field."
            Height          =   375
            Left            =   120
            TabIndex        =   38
            Top             =   1080
         ...
         Begin VB.Label Label10 
            Caption         =   "type 6, ""Inflict Condition"" and set the condition"
            Height          =   375
            Left            =   120
            TabIndex        =   37
            Top             =   720
         ...
         Begin VB.Label Label9 
            Caption         =   "To create a condition inflict spell, select the"
            Height          =   255
            Left            =   120
            TabIndex        =   36
            Top             =   360
      ...
      Begin VB.Frame info 
         ...
         Begin VB.ComboBox cmbClassReq 
            ...
            EndProperty
            Height          =   285
            ItemData        =   "frmSpellEditor.frx":00AD
            Left            =   120
            List            =   "frmSpellEditor.frx":00AF
            Style           =   2  'Dropdown List
            TabIndex        =   3
            Top             =   1080
            Width           =   4905
