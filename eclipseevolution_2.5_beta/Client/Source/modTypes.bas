...
Public MOUSE_HEIGHT As Long
Public MOUSE_WIDTH As Long
...
Public RCIINDEX As Integer
Public GIFTTO As String
Public GIFTAMT As Long
...
Public cAni As New cAniCursor
Public cClr As New cAniCursor
Public cC As New cCustomCursor
