...
Begin VB.Form frmadmin 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Tab(1).Control(1)=   "txtMap"
      Tab(1).Control(2)=   "btnLOC"
      Tab(1).Control(3)=   "btnRespawn"
      Tab(1).Control(4)=   "btnWarpto"
      Tab(1).Control(5)=   "Command62"
      Tab(1).Control(6)=   "Command63"
      Tab(1).Control(7)=   "Command64"
      Tab(1).Control(8)=   "Command65"
      Tab(1).Control(9)=   "btneditmap"
      ...
      Tab(2).Control(3)=   "tnEditNPC"
      Tab(2).Control(3).Enabled=   0   'False
      Tab(2).Control(4)=   "tnEditArrow"
      Tab(2).Control(4).Enabled=   0   'False
      Tab(2).Control(5)=   "tnEditEmoticon"
      Tab(2).Control(5).Enabled=   0   'False
      Tab(2).Control(6)=   "tnEditElement"
      Tab(2).Control(6).Enabled=   0   'False
      Tab(2).Control(7)=   "Command1"
      Tab(2).Control(7).Enabled=   0   'False
      Tab(2).Control(8)=   "Command2"
      Tab(2).Control(8).Enabled=   0   'False
      Tab(2).Control(9)=   "Command3"
...
Private Sub txtAccess_click()
    If txtAccess.Text = "Enter Access Level" Then
        txtAccess.Text = vbNullString
    End If
End Sub

Private Sub txtMap_click()
    If txtMap.Text = "Enter Map Number" Then
        txtMap.Text = vbNullString
    End If
End Sub

Private Sub txtPlayer_click()
    If txtPlayer.Text = "Enter Player Name" Then
        txtPlayer.Text = vbNullString
    End If
End Sub

Private Sub txtSprite_click()
    If txtSprite.Text = "Enter Sprite Number" Then
        txtSprite.Text = vbNullString
    End If
End Sub


Private Sub txtAccess_lostfocus()
    If txtAccess.Text = vbNullString Then
        txtAccess.Text = "Enter Access Level"
    End If
End Sub

Private Sub txtMap_lostfocus()
    If txtMap.Text = vbNullString Then
        txtMap.Text = "Enter Map Number"
    End If
End Sub

Private Sub txtPlayer_lostfocus()
    If txtPlayer.Text = vbNullString Then
        txtPlayer.Text = "Enter Player Name"
    End If
End Sub

Private Sub txtSprite_lostfocus()
    If txtSprite.Text = vbNullString Then
        txtSprite.Text = "Enter Sprite Number"
    End If
End Sub
