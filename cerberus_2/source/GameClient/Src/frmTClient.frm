   ...
   Begin VB.PictureBox picScreen 
      ...
      Begin VB.PictureBox picPlayerSkills 
         ...
         Begin VB.ListBox lstPlayerSkills 
            Height          =   1620
            ItemData        =   "frmTClient.frx":0004
            Left            =   120
            List            =   "frmTClient.frx":0006
            TabIndex        =   112
            Top             =   1320
            Width           =   3135
         End
      ...
      Begin VB.PictureBox picShopTrade 
         ...
         Begin VB.PictureBox picFixItems 
            ...
            Begin VB.ListBox lstFixItem 
               Height          =   1815
               ItemData        =   "frmTClient.frx":0008
               Left            =   120
               List            =   "frmTClient.frx":000A
               TabIndex        =   74
               Top             =   120
               Width           =   7095
            End
         ...
         Begin VB.ListBox lstShopTrade 
            Height          =   1815
            ItemData        =   "frmTClient.frx":000C
            Left            =   240
            List            =   "frmTClient.frx":000E
            TabIndex        =   69
            Top             =   480
            Width           =   7095
         End
      ...
      Begin VB.PictureBox picPlayerSpells 
         ...
         Begin VB.ListBox lstPlayerSpells 
            Height          =   2010
            ItemData        =   "frmTClient.frx":0010
            Left            =   120
            List            =   "frmTClient.frx":0012
            TabIndex        =   66
            Top             =   1320
            Width           =   3135
         End
...
Private Sub picScreen_MouseDown(Button As Integer, Shift As Integer, x As Single, y As Single)
    If Button = 2 Then
        If Int(x / 32) > (MAX_MAPX - 4) Or Int(y / 32) > (MAX_MAPY - 5) Then
            frmTClient.picRightClickMenu.top = y - 120
            frmTClient.picRightClickMenu.Left = x - 100
            frmTClient.picRightClickMenu.Visible = True
            frmTClient.tmrRightClick.Interval = 3000
            frmTClient.tmrRightClick.Enabled = True
        Else
...
lstPlayerInventory.ListIndex = Index
    ...
    ElseIf Button = 2 Then
        ...
        InvNum = frmTClient.lstPlayerInventory.ListIndex + 1
        ...
        If GetPlayerInvItemNum(MyIndex, InvNum) > 0 And GetPlayerInvItemNum(MyIndex, InvNum) <= MAX_ITEMS Then
            If Item(GetPlayerInvItemNum(MyIndex, InvNum)).Type = ITEM_TYPE_CURRENCY Then
                ...
                frmDrop.top = y - 20
                frmDrop.Left = x - 20
                'frmTClient.picScreen.SetFocus
                frmDrop.Show vbModal
            Else
                Call SendDropItem(frmTClient.lstPlayerInventory.ListIndex + 1, 0)
            End If
        End If
...
Dim I As Long
    ...
    frmTClient.lstFixItem.Clear
    For I = 1 To MAX_INV
        If GetPlayerInvItemNum(MyIndex, I) > 0 Then
            frmTClient.lstFixItem.AddItem I & ": " & Trim(Item(GetPlayerInvItemNum(MyIndex, I)).Name)
        Else
            frmTClient.lstFixItem.AddItem "Unused Slot"
        End If
    Next I
