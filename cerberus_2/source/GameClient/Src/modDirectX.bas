...
Dim FileName As String
    ...
    If FileExist(FileName & "sprites" & GFX_EXT, True) = False Or FileExist(FileName & "sprites" & GFX_EXT, True) = False Or FileExist(FileName & "tiles" & GFX_EXT, True) = False Or FileExist(FileName & "items" & GFX_EXT, True) = False Or FileExist(FileName & "arrows" & GFX_EXT, True) = False Then
    ...
    With DDSD_Item
        ...
        .ddsCaps.lCaps = DDSCAPS_OFFSCREENPLAIN Or DDSCAPS_VIDEOMEMORY
    End With
    Set DD_SkillSurf = DD.CreateSurfaceFromFile(FileName & "skills" & GFX_EXT, DDSD_Skill)
    ...
    With DDSD_Tile
        ...
        .ddsCaps.lCaps = DDSCAPS_OFFSCREENPLAIN Or DDSCAPS_VIDEOMEMORY
    End With
    Set DD_ArrowSurf = DD.CreateSurfaceFromFile(FileName & "arrows" & GFX_EXT, DDSD_Arrow)
    DD_ArrowSurf.SetColorKey DDCKEY_SRCBLT, Key
End Sub
