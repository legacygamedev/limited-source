...
Dim i As Long
    ...
    FileName = App.Path & "\Core Files\classes.ini"
...
Sub CheckClasses()
    If Not FileExist("\Core Files\classes.ini") Then
        Call SaveClasses
    End If
End Sub
...
Dim FileName As String
    ...
    FileName = App.Path & "\Core Files\items.ini"
...
Sub CheckItems()
    If Not FileExist("\Core Files\items.ini") Then
        Call SaveItems
    End If
End Sub
...
Dim i As Long
    ...
    FileName = App.Path & "\Core Files\shops.ini"
...
Sub CheckShops()
    If Not FileExist("\Core Files\shops.ini") Then
        Call SaveShops
    End If
End Sub
...
Dim i As Long
    ...
    FileName = App.Path & "\Core Files\spells.ini"
...
Sub CheckSpells()
    If Not FileExist("\Core Files\spells.ini") Then
        Call SaveSpells
    End If
End Sub
