...
Dim f As Long
    ...
    If GetVar(App.Path & "\Data.ini", "CONFIG", "ServerType") = 1 Then
    frmServer.GMOnly.Value = 1
    Else
    frmServer.GMOnly.Value = 0
    End If
    ...
    Scripting2 = GetVar(App.Path & "\Data.ini", "CONFIG", "Scripting")
    MAX_PARTY_MEMBERS = GetVar(App.Path & "\Data.ini", "MAX", "MAX_PARTY_MEMBERS")
    AUTO_ACCESS_PASSWORD = "PUTAPASSWORDHERE"
