...
' Basic Security Passwords, You can't connect without it
Public Const SEC_CODE1 = "tdcdvhpccvcqmjrlszjcogfotjawrocfdlliwoutprqtczqhyaalsiqqostpwmrjcjemfchowvnagezgcjeowoszznixvkmcoendhtwproxdivjhfgzylucnxxa"
Public Const SEC_CODE2 = "dyddmiepvmfbyydynvpmndypbwtnifoyapminjqocfjpnnyttajyxvsepngpmwifzedsfpvomyybmlcohkxklbwxzvbyzttboeyyrxxumysftnnlujyohwrxteegv"
Public Const SEC_CODE3 = "tzphzrrxdmirslqlrxrrhggjckilluebviityboxiolnrzznwagnqslurijprgjuubkjmzfshmfqeazbxtmwttonnveuqdnyqozuacjiznvmrlecuhlebzy"
Public Const SEC_CODE4 = "54074222520748368203548263820032053518317462863630115130640208820505412043827682623180483273625334288264860"
...
Public Const TILE_TYPE_SELL = 22
