...
End If
    ...
    ' :: AFK Alert Packet ::
    ' ::::::::::::::::::::::
    If LCase(Parse(0)) = "afkalert" Then
frmMirage.picScreen.Left = 8
frmMirage.picScreen.Top = 8
frmMirage.picScreen.Width = 634
frmMirage.picScreen.Height = 479
...
End If
    ...
    End If
        ...
        If LCase(Parse(0)) = "opensell" Then
...
' :: Set Startup Resting ::
' :::::::::::::::::::::::::
    If LCase(Parse(0)) = "restingset" Then
