...
Dim i As Long
    ...
    If FileExist("\GFX\sprites.png") = False Or FileExist("\GFX\items.png") = False Or FileExist("\GFX\bigsprites.png") = False Or FileExist("\GFX\emoticons.png") = False Or FileExist("\GFX\arrows.png") = False Then
    ...
    For i = 0 To ExtraSheets
        If Dir(App.Path & "\GFX\tiles" & i & ".png") <> "" Then
    ...
    Set DD_BigSpriteSurf = LoadImage(App.Path & "\GFX\bigsprites.png", DD, DDSD_BigSprite)
    ...
    Set DD_SpellAnim = LoadImage(App.Path & "\GFX\spells.png", DD, DDSD_SpellAnim)
            ...
            If Player(index).SpellAnim(i).TargetType = 0 Then
                If Player(index).SpellAnim(i).Target > 0 Then
                    If Player(index).SpellAnim(i).Target = MyIndex Then
                        x = NewX + sx
                        y = NewY + sx
                        If GetPlayerGuild(Player(index).SpellAnim(i).Target) <> "Stealth" Then
