...
Begin VB.Form frmShopEditor 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      EndProperty
      TabCaption(0)   =   "Weapon"
      TabPicture(0)   =   "frmShopEditor.frx":014A
      Tab(0).ControlEnabled=   -1  'True
      Tab(0).Control(0)=   "lstTradeItem(0)"
      Tab(0).Control(0).Enabled=   0   'False
      Tab(0).ControlCount=   1
      TabCaption(1)   =   "Shield"
      TabPicture(1)   =   "frmShopEditor.frx":0166
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "lstTradeItem(1)"
      Tab(1).ControlCount=   1
      TabCaption(2)   =   "Armor"
      TabPicture(2)   =   "frmShopEditor.frx":0182
      Tab(2).ControlEnabled=   0   'False
      Tab(2).Control(0)=   "lstTradeItem(2)"
      Tab(2).ControlCount=   1
      TabCaption(3)   =   "Helmet"
      TabPicture(3)   =   "frmShopEditor.frx":019E
      Tab(3).ControlEnabled=   0   'False
      Tab(3).Control(0)=   "lstTradeItem(3)"
      Tab(3).ControlCount=   1
      TabCaption(4)   =   "Spell"
      TabPicture(4)   =   "frmShopEditor.frx":01BA
      Tab(4).ControlEnabled=   0   'False
      Tab(4).Control(0)=   "lstTradeItem(4)"
      Tab(4).ControlCount=   1
      TabCaption(5)   =   "Others"
      TabPicture(5)   =   "frmShopEditor.frx":01D6
      ...
      Begin VB.ListBox lstTradeItem 
         ...
         Height          =   2205
         Index           =   5
         ItemData        =   "frmShopEditor.frx":01F2
         Left            =   -74880
         List            =   "frmShopEditor.frx":01F4
         TabIndex        =   26
         Top             =   360
         Width           =   4935
      End
      Begin VB.ListBox lstTradeItem 
         ...
         Height          =   2205
         Index           =   4
         ItemData        =   "frmShopEditor.frx":01F6
         Left            =   -74880
         List            =   "frmShopEditor.frx":01F8
         TabIndex        =   25
         Top             =   360
         Width           =   4935
      End
      Begin VB.ListBox lstTradeItem 
         ...
         Height          =   2205
         Index           =   3
         ItemData        =   "frmShopEditor.frx":01FA
         Left            =   -74880
         List            =   "frmShopEditor.frx":01FC
         TabIndex        =   24
         Top             =   360
         Width           =   4935
      End
      Begin VB.ListBox lstTradeItem 
         ...
         Height          =   2205
         Index           =   2
         ItemData        =   "frmShopEditor.frx":01FE
         Left            =   -74880
         List            =   "frmShopEditor.frx":0200
         TabIndex        =   23
         Top             =   360
         Width           =   4935
      End
      Begin VB.ListBox lstTradeItem 
         ...
         Height          =   2205
         Index           =   1
         ItemData        =   "frmShopEditor.frx":0202
         Left            =   -74880
         List            =   "frmShopEditor.frx":0204
         TabIndex        =   22
         Top             =   360
         Width           =   4935
      End
      Begin VB.ListBox lstTradeItem 
         ...
         Height          =   2205
         Index           =   0
         ItemData        =   "frmShopEditor.frx":0206
         Left            =   120
         List            =   "frmShopEditor.frx":0208
         TabIndex        =   21
         Top             =   360
         Width           =   4935
      End
