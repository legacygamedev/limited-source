...
Begin VB.Form frmNewChar 
   ...
   MaxButton       =   0   'False
   MinButton       =   0   'False
   Picture         =   "frmNewChar.frx":014A
   ScaleHeight     =   399
   ScaleMode       =   3  'Pixel
   ScaleWidth      =   399
   StartUpPosition =   2  'CenterScreen
   Begin VB.ComboBox MaleFemale 
      Appearance      =   0  'Flat
      BackColor       =   &H00FFFFFF&
      BeginProperty Font 
         Name            =   "Verdana"
      ...
      ForeColor       =   &H00000000&
      Height          =   300
      ItemData        =   "frmNewChar.frx":7E4B
      Left            =   1020
      List            =   "frmNewChar.frx":7E55
   ...
   Begin VB.ComboBox cmbClass 
      ...
      ForeColor       =   &H00000000&
      Height          =   300
      ItemData        =   "frmNewChar.frx":7E67
      Left            =   1020
      List            =   "frmNewChar.frx":7E69
      Style           =   2  'Dropdown List
      TabIndex        =   1
      Top             =   2430
      Width           =   2835
