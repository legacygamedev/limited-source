...
Begin VB.Form frmadmin 
   ...
   Begin VB.CommandButton btnMapReport 
      Caption         =   "Map Report"
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   6.75
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.CommandButton btnPlayerSprite 
         Caption         =   "Set the Player's Sprite"
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   6.75
            Charset         =   0
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      EndProperty
      TabCaption(0)   =   "Menu"
      TabPicture(0)   =   "frmadmin.frx":014A
      ...
      Begin VB.Label Label5 
         Caption         =   "Steel Warrior Administrative Panel"
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   6.75
            Charset         =   0
    ...
    If GetPlayerAccess(MyIndex) >= ADMIN_MAPPER Then
        If Trim(txtPlayer.Text) <> "" Then
            If Trim(txtSprite.Text) <> "" Then
                    If Not IsNumeric(Trim(txtSprite.Text)) Then
        Call AddText("Please enter a number for the sprite.", BrightRed)
        Exit Sub
        End If
               If IsPlaying(FindPlayer(Trim(txtPlayer.Text))) = True Then
                Call SendSetPlayerSprite(Trim(txtPlayer.Text), Trim(txtSprite.Text))
      Else: Call AddText("The player is not online.", BrightRed)
      End If
            End If
        End If
    Else: Call AddText("You are not authorized to carry out that action", BrightRed)
...
If Trim(txtAccess.Text) <> "" Then
        If Not IsNumeric(Trim(txtAccess.Text)) Then
        Call AddText("Please enter a number for the access level.", BrightRed)
        Exit Sub
        End If
        If Trim(txtAccess.Text) > 5 Then
               Call AddText("Please enter an access level less than or equal to 5.", BrightRed)
        Exit Sub
        End If
   ...
   Else: Call AddText("You are not authorized to carry out that action", BrightRed)
   End If
   Else: Call AddText("Please input an access level.", BrightRed)
   End If
   Else: Call AddText("Please input a player name.", BrightRed)
   End If
End Sub
