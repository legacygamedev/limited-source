...
Begin VB.Form frmMapProperties 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "frmMapProperties.frx":014A
      ...
      TabCaption(1)   =   "NPC'S"
      TabPicture(1)   =   "frmMapProperties.frx":0166
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.ComboBox cmbMoral 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMapProperties.frx":0182
            Left            =   75
            List            =   "frmMapProperties.frx":018F
      ...
      Begin VB.ComboBox cmbNpc 
         ...
         Height          =   315
         Index           =   3
         ItemData        =   "frmMapProperties.frx":01B6
         Left            =   -74880
         List            =   "frmMapProperties.frx":01B8
         Style           =   2  'Dropdown List
         TabIndex        =   12
         Top             =   1320
         Width           =   4095
      ...
      Begin VB.ComboBox cmbNpc 
         ...
         Height          =   315
         Index           =   7
         ItemData        =   "frmMapProperties.frx":01BA
         Left            =   -74880
         List            =   "frmMapProperties.frx":01BC
         Style           =   2  'Dropdown List
         TabIndex        =   8
         Top             =   2760
         Width           =   4095
      ...
      Begin VB.ComboBox cmbNpc 
         ...
         Height          =   315
         Index           =   13
         ItemData        =   "frmMapProperties.frx":01BE
         Left            =   -74880
         List            =   "frmMapProperties.frx":01C0
         Style           =   2  'Dropdown List
         TabIndex        =   2
         Top             =   4920
         Width           =   4095
