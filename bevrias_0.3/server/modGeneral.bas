...
Dim f As Long
    ...
    frmServer.lstTopics.AddItem "Paperdoll"
    frmServer.lstTopics.AddItem "Players Can't Connect"
                        ...
                        If IsPlaying(Target) And GetPlayerMap(Target) = Y Then
                            ...
                            If CanNpcAttackPlayer(X, Target) Then
                                If Not CanPlayerBlockHit(Target) Then
                                    ...
                                    Damage = Damage + Int(Rnd * 2) - 1
                                    If Damage > 0 Then
                                        Call NpcAttackPlayer(X, Target, Damage)
                                    Else
                                    Damage = GetVar(App.Path & "\Data.ini", "ADDED", "EnemyMinimumDmg")
                                    If GetVar(App.Path & "\Data.ini", "ADDED", "EnemyMinimumDmg") = 0 Then
