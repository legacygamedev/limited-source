...
Begin VB.Form frmMirage 
   ...
   Begin VB.PictureBox picInv 
      ...
      Begin VB.ListBox lstInv 
         ...
         ForeColor       =   &H00FF0000&
         Height          =   1920
         ItemData        =   "frmMirage.frx":0D41
         Left            =   0
         List            =   "frmMirage.frx":0D43
         TabIndex        =   38
         Top             =   240
         Width           =   3855
      End
   ...
   Begin VB.PictureBox picPlayerSpells 
      ...
      Begin VB.ListBox lstSpells 
         ...
         ForeColor       =   &H00FF0000&
         Height          =   1920
         ItemData        =   "frmMirage.frx":0D45
         Left            =   0
         List            =   "frmMirage.frx":0D47
         TabIndex        =   43
         Top             =   240
         Width           =   3855
      End
   ...
   Begin VB.PictureBox picGUI 
      ...
      Begin VB.PictureBox picInventory 
         ...
         Height          =   630
         Left            =   240
         Picture         =   "frmMirage.frx":4043
         ScaleHeight     =   600
         ScaleWidth      =   600
         TabIndex        =   8
         ToolTipText     =   "Backpack"
         Top             =   3000
         Width           =   630
      End
